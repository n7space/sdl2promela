...
#define Observer_States_ign 1
#define Observer_Context__state_wait 0
#define Observer_Context__state_ign 1
...
{
    assert(((Observer_States_vc == Observer_States_wait) || (Observer_States_vc == Observer_States_ign)));
}
...
{
    assert(((Observer_Context__state_vc == Observer_Context__state_wait) || (Observer_Context__state_vc == Observer_Context__state_ign)));
}
...
{
    assert(((Controller_Context__test_param_vc >= 0) && (Controller_Context__test_param_vc <= 8)));
}
