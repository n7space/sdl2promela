...
int inited;
chan Actuator_calculate_channel = [1] of {MyCommand};
...
{
    Actuator_calculate_channel!controller_calculate_Controller_calculate_p1;
}
...
Actuator_calculate_loop:
        if
        ::  nempty(Actuator_calculate_channel);
            Actuator_calculate_channel?Actuator_calculate_signal_parameter;
