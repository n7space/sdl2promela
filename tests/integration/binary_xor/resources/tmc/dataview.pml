...
#define Controller_States_waitforresultb 4
#define Controller_States_waitforresulta 5
#define Controller_Context__state_finished 0
#define Controller_Context__state_waitforresultc 1
#define Controller_Context__state_error 2
#define Controller_Context__state_waitforresultd 3
#define Controller_Context__state_waitforresultb 4
#define Controller_Context__state_waitforresulta 5
...
{
    assert(((((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_waitforresultc)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforresultd)) || (Controller_States_vc == Controller_States_waitforresultb)) || (Controller_States_vc == Controller_States_waitforresulta)));
}
...
{
    assert(((((((Controller_Context__state_vc == Controller_Context__state_finished) || (Controller_Context__state_vc == Controller_Context__state_waitforresultc)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitforresultd)) || (Controller_Context__state_vc == Controller_Context__state_waitforresultb)) || (Controller_Context__state_vc == Controller_Context__state_waitforresulta)));
}
