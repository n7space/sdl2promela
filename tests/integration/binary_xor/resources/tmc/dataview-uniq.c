...
{
    flag ret = TRUE;
    ret = asn1SccMyInteger_IsConstraintValid((&(pVal->lhs)), pErrCode);
    if (ret) {
        ret = asn1SccMyInteger_IsConstraintValid((&(pVal->rhs)), pErrCode);
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyCommand_Initialize(asn1SccMyCommand* pVal)
{
	...
	/*set lhs */
	asn1SccMyInteger_Initialize((&(pVal->lhs)));
	/*set rhs */
	asn1SccMyInteger_Initialize((&(pVal->rhs)));
}
...
flag asn1SccMyCommand_Encode(const asn1SccMyCommand* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyCommand_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode lhs */
	    ret = asn1SccMyInteger_Encode((&(pVal->lhs)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode rhs */
	        ret = asn1SccMyInteger_Encode((&(pVal->rhs)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMyCommand_Decode(asn1SccMyCommand* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode lhs */
	ret = asn1SccMyInteger_Decode((&(pVal->lhs)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode rhs */
	    ret = asn1SccMyInteger_Decode((&(pVal->rhs)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccMyCommand_IsConstraintValid(pVal, pErrCode);
}
