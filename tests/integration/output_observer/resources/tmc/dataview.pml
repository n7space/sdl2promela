...
{
    assert(((Actuator_Context_param_vc >= 0) && (Actuator_Context_param_vc <= 10)));
}
...
{
    assert(((Controller_Context_param_vc >= 0) && (Controller_Context_param_vc <= 10)));
}
...
{
    assert(((Controller_Context_reached_vc >= 0) && (Controller_Context_reached_vc <= 10)));
}
