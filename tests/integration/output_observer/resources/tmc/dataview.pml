...
{
    assert(((Actuator_Context__param_vc >= 0) && (Actuator_Context__param_vc <= 10)));
}
...
{
    assert(((Controller_Context__param_vc >= 0) && (Controller_Context__param_vc <= 10)));
}
...
{
    assert(((Controller_Context__reached_vc >= 0) && (Controller_Context__reached_vc <= 10)));
}
...
{
    assert(((MyInteger_vc >= 0) && (MyInteger_vc <= 10)));
}
