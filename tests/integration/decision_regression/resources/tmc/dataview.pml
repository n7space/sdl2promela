...
#define Actuator_States_right 0
#define Actuator_States_wait 1
#define Actuator_States_left 2
#define Actuator_Context__state_right 0
#define Actuator_Context__state_wait 1
#define Actuator_Context__state_left 2
...
{
    assert((((Actuator_States_vc == Actuator_States_right) || (Actuator_States_vc == Actuator_States_wait)) || (Actuator_States_vc == Actuator_States_left)));
}
...
{
    assert((((Actuator_Context__state_vc == Actuator_Context__state_right) || (Actuator_Context__state_vc == Actuator_Context__state_wait)) || (Actuator_Context__state_vc == Actuator_Context__state_left)));
}
