...
#define Actuator_States_left 1
#define Actuator_States_right 2
#define Actuator_Context__state_wait 0
#define Actuator_Context__state_left 1
#define Actuator_Context__state_right 2
...
{
    assert((((Actuator_States_vc == Actuator_States_wait) || (Actuator_States_vc == Actuator_States_left)) || (Actuator_States_vc == Actuator_States_right)));
}
...
{
    assert((((Actuator_Context__state_vc == Actuator_Context__state_wait) || (Actuator_Context__state_vc == Actuator_Context__state_left)) || (Actuator_Context__state_vc == Actuator_Context__state_right)));
}
