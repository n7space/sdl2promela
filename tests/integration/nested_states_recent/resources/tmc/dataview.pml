...
#define Controller_Context__status_param int
...
#define Actuator_Context__state_nested_0_second 0
...
#define Controller_States_waitforresultagain 0
...
#define Controller_Context__state_waitforresultagain 0
#define Controller_Context__state_waitforresult 1
#define Controller_Context__state_waitforexit 2
#define Controller_Context__state_waitforreentry 3
#define Controller_Context__state_error 4
#define Controller_Context__state_waitforentry 5
#define Controller_Context__state_finished 6
...
#define Controller_Context__status_param_on_entry 0
#define Controller_Context__status_param_on_exit 1
...
typedef Controller_Context {
    ...
    Controller_Context__status_param status_param;
...
{
    assert(((Actuator_Context__state_vc == Actuator_Context__state_nested_0_second) || (Actuator_Context__state_vc == Actuator_Context__state_nested_0_first)));
}
...
{
    assert(((Actuator_Context__nested_0_result_param_vc >= 0) && (Actuator_Context__nested_0_result_param_vc <= 10000)));
}
...
{
    assert((((((((Controller_States_vc == Controller_States_waitforresultagain) || (Controller_States_vc == Controller_States_waitforresult)) || (Controller_States_vc == Controller_States_waitforexit)) || (Controller_States_vc == Controller_States_waitforreentry)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforentry)) || (Controller_States_vc == Controller_States_finished)));
}
...
{
    assert((((((((Controller_Context__state_vc == Controller_Context__state_waitforresultagain) || (Controller_Context__state_vc == Controller_Context__state_waitforresult)) || (Controller_Context__state_vc == Controller_Context__state_waitforexit)) || (Controller_Context__state_vc == Controller_Context__state_waitforreentry)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitforentry)) || (Controller_Context__state_vc == Controller_Context__state_finished)));
}
...
inline Controller_Context__status_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context__status_param_range_check(dst);
}
inline Controller_Context__status_param_range_check(Controller_Context__status_param_vc)
{
    assert(((Controller_Context__status_param_vc == Controller_Context__status_param_on_entry) || (Controller_Context__status_param_vc == Controller_Context__status_param_on_exit)));
}
...
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__status_param_assign_value(dst.status_param, src.status_param);
