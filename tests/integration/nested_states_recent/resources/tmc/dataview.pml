...
#define Controller_States_waitforresult 3
#define Controller_States_waitforresultagain 4
#define Controller_States_waitforexit 5
#define Controller_States_waitforentry 6
#define Controller_Context_state_error 0
#define Controller_Context_state_finished 1
#define Controller_Context_state_waitforreentry 2
#define Controller_Context_state_waitforresult 3
#define Controller_Context_state_waitforresultagain 4
#define Controller_Context_state_waitforexit 5
#define Controller_Context_state_waitforentry 6
...
{
    assert((((((((Controller_States_vc == Controller_States_error) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforreentry)) || (Controller_States_vc == Controller_States_waitforresult)) || (Controller_States_vc == Controller_States_waitforresultagain)) || (Controller_States_vc == Controller_States_waitforexit)) || (Controller_States_vc == Controller_States_waitforentry)));
}
...
{
    assert((((((((Controller_Context_state_vc == Controller_Context_state_error) || (Controller_Context_state_vc == Controller_Context_state_finished)) || (Controller_Context_state_vc == Controller_Context_state_waitforreentry)) || (Controller_Context_state_vc == Controller_Context_state_waitforresult)) || (Controller_Context_state_vc == Controller_Context_state_waitforresultagain)) || (Controller_Context_state_vc == Controller_Context_state_waitforexit)) || (Controller_Context_state_vc == Controller_Context_state_waitforentry)));
}
