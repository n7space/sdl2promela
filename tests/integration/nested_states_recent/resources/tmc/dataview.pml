...
#define Controller_States_waitforreentry 2
#define Controller_States_error 3
#define Controller_States_waitforexit 4
#define Controller_States_waitforresultagain 5
#define Controller_States_waitforentry 6
#define Controller_Context__state_finished 0
#define Controller_Context__state_waitforresult 1
#define Controller_Context__state_waitforreentry 2
#define Controller_Context__state_error 3
#define Controller_Context__state_waitforexit 4
#define Controller_Context__state_waitforresultagain 5
#define Controller_Context__state_waitforentry 6
...
{
    assert((((((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_waitforresult)) || (Controller_States_vc == Controller_States_waitforreentry)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforexit)) || (Controller_States_vc == Controller_States_waitforresultagain)) || (Controller_States_vc == Controller_States_waitforentry)));
}
...
{
    assert((((((((Controller_Context__state_vc == Controller_Context__state_finished) || (Controller_Context__state_vc == Controller_Context__state_waitforresult)) || (Controller_Context__state_vc == Controller_Context__state_waitforreentry)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitforexit)) || (Controller_Context__state_vc == Controller_Context__state_waitforresultagain)) || (Controller_Context__state_vc == Controller_Context__state_waitforentry)));
}
