...
#define asn1SccMyStatus_on_entry MyStatus_on_entry
#define asn1SccMyStatus_on_exit MyStatus_on_exit

#define ERR_MYSTATUS		6  /*on-entry | on-exit*/
...
#define asn1SccMyStatus_REQUIRED_BITS_FOR_ENCODING        1
