...
{
    assert((((Observer_Context_state_vc == Observer_Context_state_error) || (Observer_Context_state_vc == Observer_Context_state_idle)) || (Observer_Context_state_vc == Observer_Context_state_reached)));
}
