...
{
    assert((((Observer_States_vc == Observer_States_idle) || (Observer_States_vc == Observer_States_error)) || (Observer_States_vc == Observer_States_reached)));
}
...
{
    assert((((Observer_Context__state_vc == Observer_Context__state_idle) || (Observer_Context__state_vc == Observer_Context__state_error)) || (Observer_Context__state_vc == Observer_Context__state_reached)));
}
