...
#define Controller_Context_coeff int
...
#define Observer_Context_state_reached 2
...
typedef Controller_Context {
    ...
    Controller_Context_coeff coeff;
}
...
{
    assert((((Observer_Context_state_vc == Observer_Context_state_idle) || (Observer_Context_state_vc == Observer_Context_state_error)) || (Observer_Context_state_vc == Observer_Context_state_reached)));
}
...
inline Controller_Context_coeff_assign_value(dst, src)
{
    dst = src;
    Controller_Context_coeff_range_check(dst);
}
inline Controller_Context_coeff_range_check(Controller_Context_coeff_vc)
{
    assert(((Controller_Context_coeff_vc >= 0) && (Controller_Context_coeff_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_coeff_assign_value(dst.coeff, src.coeff);
}
