...
#define System_State_controller_coeff int
...
typedef System_State_controller {
    ...
    System_State_controller_coeff coeff;
}
...
inline System_State_controller_coeff_assign_value(dst, src)
{
    dst = src;
    System_State_controller_coeff_range_check(dst);
}
inline System_State_controller_coeff_range_check(System_State_controller_coeff_vc)
{
    assert(((System_State_controller_coeff_vc >= 0) && (System_State_controller_coeff_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_coeff_assign_value(dst.coeff, src.coeff);
}
