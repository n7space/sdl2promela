...
flag asn1SccMyResultInteger_IsConstraintValid(const asn1SccMyResultInteger* pVal, int* pErrCode)
{
    flag ret = TRUE;
    ret = ((*(pVal)) <= 10000UL);
    *pErrCode = ret ? 0 :  ERR_MYRESULTINTEGER;
...
flag asn1SccMyResultInteger_Encode(const asn1SccMyResultInteger* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyResultInteger_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
...
flag asn1SccMyResultInteger_Decode(asn1SccMyResultInteger* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYRESULTINTEGER;

	return ret  && asn1SccMyResultInteger_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = ((((((((((*(pVal)) == PID_controller)) || (((*(pVal)) == PID_down)))) || (((*(pVal)) == PID_environ)))) || (((*(pVal)) == PID_up)))) || (((*(pVal)) == PID_env)));
