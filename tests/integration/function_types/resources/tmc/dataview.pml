...
inline System_State_down_queue_assign_value(dst, src)
{
    ...
    for(i_1 : 0 .. (src.length - 1))
    {
        System_State_down_queue_elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
    for(i_1 : src.length .. 1)
    {
        System_State_down_queue_elem_init_value(dst.data[i_1]);
    }
    dst.length = src.length;
}
...
inline System_State_up_queue_assign_value(dst, src)
{
    ...
    for(i_1 : 0 .. (src.length - 1))
    {
        System_State_up_queue_elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
    for(i_1 : src.length .. 1)
    {
        System_State_up_queue_elem_init_value(dst.data[i_1]);
    }
    dst.length = src.length;
}
