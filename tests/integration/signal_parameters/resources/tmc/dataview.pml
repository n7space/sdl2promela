...
#define Actuator_Context__first_check_param int
#define Actuator_Context__second_check_param int
...
#define Actuator_Context__state_second 1
...
#define Controller_Context__state_operationa 0
#define Controller_Context__state_wait 1
#define Controller_Context__state_operationb 2
...
typedef Actuator_Context {
    ...
    Actuator_Context__first_check_param first_check_param;
    Actuator_Context__second_check_param second_check_param;
...
{
    assert(((Actuator_States_vc == Actuator_States_first) || (Actuator_States_vc == Actuator_States_second)));
}
...
{
    assert(((Actuator_Context__state_vc == Actuator_Context__state_first) || (Actuator_Context__state_vc == Actuator_Context__state_second)));
}
...
inline Actuator_Context__first_check_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__first_check_param_range_check(dst);
}
inline Actuator_Context__first_check_param_range_check(Actuator_Context__first_check_param_vc)
{
    assert(((Actuator_Context__first_check_param_vc >= 0) && (Actuator_Context__first_check_param_vc <= 10000)));
}
inline Actuator_Context__second_check_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__second_check_param_range_check(dst);
}
inline Actuator_Context__second_check_param_range_check(Actuator_Context__second_check_param_vc)
{
    assert(((Actuator_Context__second_check_param_vc >= 0) && (Actuator_Context__second_check_param_vc <= 10000)));
}
...
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__first_check_param_assign_value(dst.first_check_param, src.first_check_param);
    Actuator_Context__second_check_param_assign_value(dst.second_check_param, src.second_check_param);
...
{
    assert((((Controller_States_vc == Controller_States_operationa) || (Controller_States_vc == Controller_States_wait)) || (Controller_States_vc == Controller_States_operationb)));
}
...
{
    assert((((Controller_Context__state_vc == Controller_Context__state_operationa) || (Controller_Context__state_vc == Controller_Context__state_wait)) || (Controller_Context__state_vc == Controller_Context__state_operationb)));
}
...
{
    assert(((Controller_Context__test_param_vc >= 0) && (Controller_Context__test_param_vc <= 10)));
}
...
{
    assert(((Controller_Context__check_param_vc >= 0) && (Controller_Context__check_param_vc <= 10000)));
}
