...
{
    flag ret = TRUE;
    ret = asn1SccTestInteger_IsConstraintValid(pVal, pErrCode);
...
flag asn1SccEnviron_test_p1_Encode(const asn1SccEnviron_test_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    ret = asn1SccTestInteger_Encode(pVal, pBitStrm, pErrCode, FALSE);
    } /*COVERAGE_IGNORE*/
...
flag asn1SccEnviron_test_p1_Decode(asn1SccEnviron_test_p1* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = asn1SccTestInteger_Decode(pVal, pBitStrm, pErrCode);
