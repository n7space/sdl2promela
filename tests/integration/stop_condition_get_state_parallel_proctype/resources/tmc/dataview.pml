...
#define Actuator_Context_sender_inst 1
...
#define Controller_Context_offspring_inst 1
...
{
    assert((((Actuator_Context_sender_vc == Actuator_Context_sender_actuator) || (Actuator_Context_sender_vc == Actuator_Context_sender_inst)) || (Actuator_Context_sender_vc == Actuator_Context_sender_env)));
}
...
{
    assert((((Actuator_Context_offspring_vc == Actuator_Context_offspring_actuator) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_inst)) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_env)));
}
...
{
    assert((((Controller_Context_sender_vc == Controller_Context_sender_actuator) || (Controller_Context_sender_vc == Controller_Context_sender_inst)) || (Controller_Context_sender_vc == Controller_Context_sender_env)));
}
...
{
    assert((((Controller_Context_offspring_vc == Controller_Context_offspring_actuator) || (Controller_Context_offspring_vc == Controller_Context_offspring_inst)) || (Controller_Context_offspring_vc == Controller_Context_offspring_env)));
}
...
{
    assert((((PID_vc == PID_actuator) || (PID_vc == PID_inst)) || (PID_vc == PID_env)));
}
