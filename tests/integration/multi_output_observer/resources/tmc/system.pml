...
{
    atomic {
        (empty(Actuator_change_observer_f1_channel) && (empty(Actuator_zero_observer_f1_channel) && (empty(Actuator_f1_channel) && (empty(Actuator_change_observer_f2_channel) && (empty(Actuator_zero_observer_f2_channel) && empty(Actuator_f2_channel))))));
    }
}
...
active proctype Actuator_f1() priority 1
{
    ...
    do
    ::  atomic {
        (nempty(Actuator_f1_channel) || (nempty(Actuator_change_observer_f1_channel) || nempty(Actuator_zero_observer_f1_channel)));
        Actuator_lock?_;
        if
...
active proctype Actuator_f2() priority 1
{
    ...
    do
    ::  atomic {
        (nempty(Actuator_f2_channel) || (nempty(Actuator_change_observer_f2_channel) || nempty(Actuator_zero_observer_f2_channel)));
        Actuator_lock?_;
        if
