...
#define ERR_MYTESTPARAMETER		21  /*(SIZE(4))*/
...
#define asn1SccMyTestParameter_REQUIRED_BYTES_FOR_ENCODING       7
#define asn1SccMyTestParameter_REQUIRED_BITS_FOR_ENCODING        56
