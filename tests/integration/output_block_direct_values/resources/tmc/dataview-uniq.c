...
{
    flag ret = TRUE;
    ret = asn1SccMyInteger_IsConstraintValid((&(pVal->first)), pErrCode);
    if (ret) {
        ret = asn1SccMyInteger_IsConstraintValid((&(pVal->second)), pErrCode);
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyData_Initialize(asn1SccMyData* pVal)
{
	...
	/*set first */
	asn1SccMyInteger_Initialize((&(pVal->first)));
	/*set second */
	asn1SccMyInteger_Initialize((&(pVal->second)));
}
...
flag asn1SccMyData_Encode(const asn1SccMyData* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyData_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode first */
	    ret = asn1SccMyInteger_Encode((&(pVal->first)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode second */
	        ret = asn1SccMyInteger_Encode((&(pVal->second)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMyData_Decode(asn1SccMyData* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode first */
	ret = asn1SccMyInteger_Decode((&(pVal->first)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode second */
	    ret = asn1SccMyInteger_Decode((&(pVal->second)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccMyData_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = asn1SccMyInteger_IsConstraintValid((&(pVal->black)), pErrCode);
    if (ret) {
        ret = asn1SccMyData_IsConstraintValid((&(pVal->red)), pErrCode);
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyNested_Initialize(asn1SccMyNested* pVal)
{
	...
	/*set black */
	asn1SccMyInteger_Initialize((&(pVal->black)));
	/*set red */
	asn1SccMyData_Initialize((&(pVal->red)));
}
...
flag asn1SccMyNested_Encode(const asn1SccMyNested* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyNested_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode black */
	    ret = asn1SccMyInteger_Encode((&(pVal->black)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode red */
	        ret = asn1SccMyData_Encode((&(pVal->red)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMyNested_Decode(asn1SccMyNested* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode black */
	ret = asn1SccMyInteger_Decode((&(pVal->black)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode red */
	    ret = asn1SccMyData_Decode((&(pVal->red)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccMyNested_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    if (pVal->kind == MyValues_left_PRESENT) {
    	ret = asn1SccMyInteger_IsConstraintValid((&(pVal->u.left)), pErrCode);
    }
    if (ret) {
        if (pVal->kind == MyValues_right_PRESENT) {
        	ret = asn1SccMyInteger_IsConstraintValid((&(pVal->u.right)), pErrCode);
        }
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyValues_Initialize(asn1SccMyValues* pVal)
{
	...
	pVal->kind = MyValues_left_PRESENT;
	pVal->u.left = 0UL;
}
...
flag asn1SccMyValues_Encode(const asn1SccMyValues* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyValues_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    switch(pVal->kind)
	    {
	    case MyValues_left_PRESENT:
	    	BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 1);
	    	ret = asn1SccMyInteger_Encode((&(pVal->u.left)), pBitStrm, pErrCode, FALSE);
	    	break;
	    case MyValues_right_PRESENT:
	    	BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 1);
	    	ret = asn1SccMyInteger_Encode((&(pVal->u.right)), pBitStrm, pErrCode, FALSE);
	    	break;
	    default:                            /*COVERAGE_IGNORE*/
	        *pErrCode = ERR_UPER_ENCODE_MYVALUES;         /*COVERAGE_IGNORE*/
...
flag asn1SccMyValues_Decode(asn1SccMyValues* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	asn1SccSint asn1SccMyValues_index_tmp;

	ret = BitStream_DecodeConstraintWholeNumber(pBitStrm, &asn1SccMyValues_index_tmp, 0, 1);
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYVALUES;
	if (ret) {
	    switch(asn1SccMyValues_index_tmp)
	    {
	    case 0:
	    	pVal->kind = MyValues_left_PRESENT;
	    	ret = asn1SccMyInteger_Decode((&(pVal->u.left)), pBitStrm, pErrCode);
	    	break;
	    case 1:
	    	pVal->kind = MyValues_right_PRESENT;
	    	ret = asn1SccMyInteger_Decode((&(pVal->u.right)), pBitStrm, pErrCode);
	    	break;
	    default:                        /*COVERAGE_IGNORE*/
	        *pErrCode = ERR_UPER_DECODE_MYVALUES;     /*COVERAGE_IGNORE*/
	        ret = FALSE;                /*COVERAGE_IGNORE*/
	    }
	}  /*COVERAGE_IGNORE*/

	return ret  && asn1SccMyValues_IsConstraintValid(pVal, pErrCode);
}
