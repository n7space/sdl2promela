...
#define Controller_States_waitforvalues 3
#define Controller_States_waitfornested 4
#define Controller_States_waitforarray 5
#define Controller_Context__state_waitfordata 0
#define Controller_Context__state_error 1
#define Controller_Context__state_finished 2
#define Controller_Context__state_waitforvalues 3
#define Controller_Context__state_waitfornested 4
#define Controller_Context__state_waitforarray 5
...
{
    assert(((((((Controller_States_vc == Controller_States_waitfordata) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforvalues)) || (Controller_States_vc == Controller_States_waitfornested)) || (Controller_States_vc == Controller_States_waitforarray)));
}
...
{
    assert(((((((Controller_Context__state_vc == Controller_Context__state_waitfordata) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_finished)) || (Controller_Context__state_vc == Controller_Context__state_waitforvalues)) || (Controller_Context__state_vc == Controller_Context__state_waitfornested)) || (Controller_Context__state_vc == Controller_Context__state_waitforarray)));
}
