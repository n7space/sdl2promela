...
#define Observer_Context__some_variable int
...
#define Controller_Context__dummy int
...
typedef Controller_Context {
    ...
    Controller_Context__dummy dummy;
}
...
typedef Observer_Context {
    ...
    Observer_Context__some_variable some_variable;
}
...
{
    assert((((Observer_States_vc == Observer_States_idle) || (Observer_States_vc == Observer_States_reached)) || (Observer_States_vc == Observer_States_error)));
}
...
{
    assert((((Observer_Context__state_vc == Observer_Context__state_idle) || (Observer_Context__state_vc == Observer_Context__state_reached)) || (Observer_Context__state_vc == Observer_Context__state_error)));
}
...
inline Observer_Context__some_variable_assign_value(dst, src)
{
    dst = src;
    Observer_Context__some_variable_range_check(dst);
}
inline Observer_Context__some_variable_range_check(Observer_Context__some_variable_vc)
{
    assert(((Observer_Context__some_variable_vc >= 0) && (Observer_Context__some_variable_vc <= 10000)));
}
inline Observer_Context_assign_value(dst, src)
{
    ...
    Observer_Context__some_variable_assign_value(dst.some_variable, src.some_variable);
}
...
inline Controller_Context__dummy_assign_value(dst, src)
{
    dst = src;
    Controller_Context__dummy_range_check(dst);
}
inline Controller_Context__dummy_range_check(Controller_Context__dummy_vc)
{
    assert(((Controller_Context__dummy_vc >= 0) && (Controller_Context__dummy_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__dummy_assign_value(dst.dummy, src.dummy);
}
