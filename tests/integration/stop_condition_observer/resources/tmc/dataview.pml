...
#define Observer_Context_some_variable int
...
#define Controller_Context_dummy int
...
#define Observer_Context_state_error 2
...
typedef Controller_Context {
    ...
    Controller_Context_dummy dummy;
}
...
typedef Observer_Context {
    ...
    Observer_Context_some_variable some_variable;
}
...
{
    assert((((Observer_Context_state_vc == Observer_Context_state_idle) || (Observer_Context_state_vc == Observer_Context_state_reached)) || (Observer_Context_state_vc == Observer_Context_state_error)));
}
...
inline Observer_Context_some_variable_assign_value(dst, src)
{
    dst = src;
    Observer_Context_some_variable_range_check(dst);
}
inline Observer_Context_some_variable_range_check(Observer_Context_some_variable_vc)
{
    assert(((Observer_Context_some_variable_vc >= 0) && (Observer_Context_some_variable_vc <= 10000)));
}
inline Observer_Context_assign_value(dst, src)
{
    ...
    Observer_Context_some_variable_assign_value(dst.some_variable, src.some_variable);
}
...
inline Controller_Context_dummy_assign_value(dst, src)
{
    dst = src;
    Controller_Context_dummy_range_check(dst);
}
inline Controller_Context_dummy_range_check(Controller_Context_dummy_vc)
{
    assert(((Controller_Context_dummy_vc >= 0) && (Controller_Context_dummy_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_dummy_assign_value(dst.dummy, src.dummy);
}
