...
#define System_State_controller_dummy int
...
typedef System_State_controller {
    ...
    System_State_controller_dummy dummy;
}
...
inline System_State_controller_dummy_assign_value(dst, src)
{
    dst = src;
    System_State_controller_dummy_range_check(dst);
}
inline System_State_controller_dummy_range_check(System_State_controller_dummy_vc)
{
    assert(((System_State_controller_dummy_vc >= 0) && (System_State_controller_dummy_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_dummy_assign_value(dst.dummy, src.dummy);
}
