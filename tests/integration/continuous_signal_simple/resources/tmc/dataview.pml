...
#define Controller_Context_success int
...
{
    dst = src;
    Controller_Context_success_range_check(dst);
}
inline Controller_Context_success_range_check(Controller_Context_success_vc)
{
    assert(((Controller_Context_success_vc >= 0) && (Controller_Context_success_vc <= 10000)));
}
