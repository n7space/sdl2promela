...
#define Controller_Context__success int
...
typedef Controller_Context {
    ...
    Controller_Context__success success;
}
...
{
    assert(((Actuator_Context__check_param_vc >= 0) && (Actuator_Context__check_param_vc <= 10000)));
}
...
inline Controller_Context__success_assign_value(dst, src)
{
    dst = src;
    Controller_Context__success_range_check(dst);
}
inline Controller_Context__success_range_check(Controller_Context__success_vc)
{
    assert(((Controller_Context__success_vc >= 0) && (Controller_Context__success_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__success_assign_value(dst.success, src.success);
}
