...
#define System_State_actuator_seq_first int
#define System_State_actuator_seq_second int
#define System_State_actuator_arr_elem int
#define System_State_actuator_alt_left int
#define System_State_actuator_alt_right_first int
#define System_State_actuator_alt_right_second int
...
#define System_State_controller_apollo int
...
#define System_State_actuator_alt_NONE 0
#define System_State_actuator_alt_left_PRESENT 1
#define System_state_actuator_alt_selection_left_PRESENT 1
#define System_State_actuator_alt_right_PRESENT 2
#define System_state_actuator_alt_selection_right_PRESENT 2
...
typedef System_State_actuator_alt_right {
    System_State_actuator_alt_right_first first;
    System_State_actuator_alt_right_second second;
}

typedef System_State_actuator_arr {
    System_State_actuator_arr_elem data[2];
}
...
typedef System_State_actuator_seq {
    System_State_actuator_seq_first first;
    System_State_actuator_seq_second second;
}
...
typedef System_State_controller {
    ...
    System_State_controller_apollo apollo;
}
...
typedef System_State_actuator_alt_data {
    System_State_actuator_alt_left left;
    System_State_actuator_alt_right right;
}
...
typedef System_State_actuator_alt {
    System_State_actuator_alt_data data;
    int selection;
}
...
typedef System_State_actuator {
    ...
    System_State_actuator_seq seq;
    System_State_actuator_arr arr;
    System_State_actuator_alt alt;
}
...
inline System_State_actuator_seq_first_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_seq_first_range_check(dst);
}
inline System_State_actuator_seq_first_range_check(System_State_actuator_seq_first_vc)
{
    assert(((System_State_actuator_seq_first_vc >= 0) && (System_State_actuator_seq_first_vc <= 10000)));
}
inline System_State_actuator_seq_second_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_seq_second_range_check(dst);
}
inline System_State_actuator_seq_second_range_check(System_State_actuator_seq_second_vc)
{
    assert(((System_State_actuator_seq_second_vc >= 0) && (System_State_actuator_seq_second_vc <= 10000)));
}
inline System_State_actuator_seq_assign_value(dst, src)
{
    System_State_actuator_seq_first_assign_value(dst.first, src.first);
    System_State_actuator_seq_second_assign_value(dst.second, src.second);
}
inline System_State_actuator_arr_elem_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_arr_elem_range_check(dst);
}
inline System_State_actuator_arr_elem_range_check(System_State_actuator_arr_elem_vc)
{
    assert(((System_State_actuator_arr_elem_vc >= 0) && (System_State_actuator_arr_elem_vc <= 10000)));
}
inline System_State_actuator_arr_elem_init_value(dst)
{
    System_State_actuator_arr_elem_assign_value(dst, 0);
}
inline System_State_actuator_arr_assign_value(dst, src)
{
    int i_2;
    for(i_2 : 0 .. 1)
    {
        System_State_actuator_arr_elem_assign_value(dst.data[i_2], src.data[i_2]);
    }
}
inline System_State_actuator_alt_left_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_alt_left_range_check(dst);
}
inline System_State_actuator_alt_left_range_check(System_State_actuator_alt_left_vc)
{
    assert(((System_State_actuator_alt_left_vc >= 0) && (System_State_actuator_alt_left_vc <= 10000)));
}
inline System_State_actuator_alt_right_first_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_alt_right_first_range_check(dst);
}
inline System_State_actuator_alt_right_first_range_check(System_State_actuator_alt_right_first_vc)
{
    assert(((System_State_actuator_alt_right_first_vc >= 0) && (System_State_actuator_alt_right_first_vc <= 10000)));
}
inline System_State_actuator_alt_right_second_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_alt_right_second_range_check(dst);
}
inline System_State_actuator_alt_right_second_range_check(System_State_actuator_alt_right_second_vc)
{
    assert(((System_State_actuator_alt_right_second_vc >= 0) && (System_State_actuator_alt_right_second_vc <= 10000)));
}
inline System_State_actuator_alt_right_assign_value(dst, src)
{
    System_State_actuator_alt_right_first_assign_value(dst.first, src.first);
    System_State_actuator_alt_right_second_assign_value(dst.second, src.second);
}
inline System_State_actuator_alt_assign_value(dst, src)
{
    dst.selection = src.selection;
    if
    ::  (dst.selection == System_State_actuator_alt_left_PRESENT);
        System_State_actuator_alt_left_assign_value(dst.data.left, src.data.left);
    ::  (dst.selection == System_State_actuator_alt_right_PRESENT);
        System_State_actuator_alt_right_assign_value(dst.data.right, src.data.right);
    ::  else;
        skip;
    fi;
}
inline System_state_actuator_alt_selection_assign_value(dst, src)
{
    dst = src;
}
inline System_State_actuator_assign_value(dst, src)
{
    ...
    System_State_actuator_seq_assign_value(dst.seq, src.seq);
    System_State_actuator_arr_assign_value(dst.arr, src.arr);
    System_State_actuator_alt_assign_value(dst.alt, src.alt);
}
...
inline System_State_controller_apollo_assign_value(dst, src)
{
    dst = src;
    System_State_controller_apollo_range_check(dst);
}
inline System_State_controller_apollo_range_check(System_State_controller_apollo_vc)
{
    assert(((System_State_controller_apollo_vc >= 0) && (System_State_controller_apollo_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_apollo_assign_value(dst.apollo, src.apollo);
}
