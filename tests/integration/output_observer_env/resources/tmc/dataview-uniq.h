...
#define asn1SccMyInteger_REQUIRED_BITS_FOR_ENCODING        2
...
typedef asn1SccMyInteger asn1SccEnviron_pong_p1;


#define ERR_ENVIRON_PONG_P1_2		86  /**/
flag asn1SccEnviron_pong_p1_IsConstraintValid(const asn1SccEnviron_pong_p1* pVal, int* pErrCode);

void asn1SccEnviron_pong_p1_Initialize(asn1SccEnviron_pong_p1* pVal);

#define ERR_UPER_ENCODE_ENVIRON_PONG_P1_2		87  /**/
#define asn1SccEnviron_pong_p1_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccEnviron_pong_p1_REQUIRED_BITS_FOR_ENCODING        2

flag asn1SccEnviron_pong_p1_Encode(const asn1SccEnviron_pong_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_ENVIRON_PONG_P1_2		88  /**/
flag asn1SccEnviron_pong_p1_Decode(asn1SccEnviron_pong_p1* pVal, BitStream* pBitStrm, int* pErrCode);
typedef asn1SccMyInteger asn1SccEnviron_ping_p1;


#define ERR_ENVIRON_PING_P1_2		96  /**/
flag asn1SccEnviron_ping_p1_IsConstraintValid(const asn1SccEnviron_ping_p1* pVal, int* pErrCode);

void asn1SccEnviron_ping_p1_Initialize(asn1SccEnviron_ping_p1* pVal);

#define ERR_UPER_ENCODE_ENVIRON_PING_P1_2		97  /**/
#define asn1SccEnviron_ping_p1_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccEnviron_ping_p1_REQUIRED_BITS_FOR_ENCODING        2

flag asn1SccEnviron_ping_p1_Encode(const asn1SccEnviron_ping_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_ENVIRON_PING_P1_2		98  /**/
flag asn1SccEnviron_ping_p1_Decode(asn1SccEnviron_ping_p1* pVal, BitStream* pBitStrm, int* pErrCode);
...
#define ERR_PID		76  /*controller | environ | env*/
