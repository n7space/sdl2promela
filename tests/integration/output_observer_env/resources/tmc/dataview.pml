...
#define Observer_Environ_Event_Msg_In_Selection int
...
#define PID int
#define Environ_pong_p1 int
#define Environ_ping_p1 int
...
#define Observer_Context__sender_controller 0
#define Observer_Context__sender_environ 1
#define Observer_Context__sender_env 2
#define Observer_Context__offspring_controller 0
#define Observer_Context__offspring_environ 1
#define Observer_Context__offspring_env 2
#define Observer_Controller_Event_Msg_In_Selection_input_none_present 1
#define Observer_Controller_Event_Msg_In_Selection_ping_present 2
#define Observer_Controller_Event_Msg_Out_Selection_pong_present 1
#define Observer_Controller_Event_Selection_msg_in_present 1
#define Observer_Controller_Event_Selection_msg_out_present 2
#define Observer_Environ_Event_Msg_In_Selection_pong_present 1
#define Observer_Environ_Event_Msg_Out_Selection_ping_present 1
#define Observer_Environ_Event_Selection_msg_in_present 1
#define Observer_Environ_Event_Selection_msg_out_present 2
#define Observer_Function_Event_Selection_controller_present 1
#define Observer_Function_Event_Selection_environ_present 2
...
#define Controller_Context__sender_environ 1
#define Controller_Context__sender_env 2
#define Controller_Context__offspring_controller 0
#define Controller_Context__offspring_environ 1
#define Controller_Context__offspring_env 2
...
{
    assert((Observer_States_vc == Observer_States_wait));
}
...
{
    assert((Observer_Context__state_vc == Observer_Context__state_wait));
}
...
{
    assert((((Observer_Context__sender_vc == Observer_Context__sender_controller) || (Observer_Context__sender_vc == Observer_Context__sender_environ)) || (Observer_Context__sender_vc == Observer_Context__sender_env)));
}
...
{
    assert((((Observer_Context__offspring_vc == Observer_Context__offspring_controller) || (Observer_Context__offspring_vc == Observer_Context__offspring_environ)) || (Observer_Context__offspring_vc == Observer_Context__offspring_env)));
}
...
{
    assert(((Observer_Controller_Event_Msg_In_Selection_vc == Observer_Controller_Event_Msg_In_Selection_input_none_present) || (Observer_Controller_Event_Msg_In_Selection_vc == Observer_Controller_Event_Msg_In_Selection_ping_present)));
}
...
{
    assert((Observer_Controller_Event_Msg_Out_Selection_vc == Observer_Controller_Event_Msg_Out_Selection_pong_present));
}
...
inline Observer_Environ_Event_Msg_In_Selection_assign_value(dst, src)
{
    dst = src;
    Observer_Environ_Event_Msg_In_Selection_range_check(dst);
}
inline Observer_Environ_Event_Msg_In_Selection_range_check(Observer_Environ_Event_Msg_In_Selection_vc)
{
    assert((Observer_Environ_Event_Msg_In_Selection_vc == Observer_Environ_Event_Msg_In_Selection_pong_present));
}
...
{
    assert((Observer_Environ_Event_Msg_Out_Selection_vc == Observer_Environ_Event_Msg_Out_Selection_ping_present));
}
...
{
    assert(((Observer_Environ_Event_Selection_vc == Observer_Environ_Event_Selection_msg_in_present) || (Observer_Environ_Event_Selection_vc == Observer_Environ_Event_Selection_msg_out_present)));
}
...
{
    assert(((Observer_Function_Event_Selection_vc == Observer_Function_Event_Selection_controller_present) || (Observer_Function_Event_Selection_vc == Observer_Function_Event_Selection_environ_present)));
}
...
{
    assert((((Controller_Context__sender_vc == Controller_Context__sender_controller) || (Controller_Context__sender_vc == Controller_Context__sender_environ)) || (Controller_Context__sender_vc == Controller_Context__sender_env)));
}
...
{
    assert((((Controller_Context__offspring_vc == Controller_Context__offspring_controller) || (Controller_Context__offspring_vc == Controller_Context__offspring_environ)) || (Controller_Context__offspring_vc == Controller_Context__offspring_env)));
}
...
{
    assert(((Controller_Context__error_vc >= 0) && (Controller_Context__error_vc <= 3)));
}
...
{
    assert(((Controller_Context__param_vc >= 0) && (Controller_Context__param_vc <= 3)));
}
...
{
    assert(((MyInteger_vc >= 0) && (MyInteger_vc <= 3)));
}
...
{
    assert((((PID_vc == PID_controller) || (PID_vc == PID_environ)) || (PID_vc == PID_env)));
}
inline Environ_pong_p1_assign_value(dst, src)
{
    dst = src;
    Environ_pong_p1_range_check(dst);
}
inline Environ_pong_p1_range_check(Environ_pong_p1_vc)
{
    assert(((Environ_pong_p1_vc >= 0) && (Environ_pong_p1_vc <= 3)));
}
inline Environ_ping_p1_assign_value(dst, src)
{
    dst = src;
    Environ_ping_p1_range_check(dst);
}
inline Environ_ping_p1_range_check(Environ_ping_p1_vc)
{
    assert(((Environ_ping_p1_vc >= 0) && (Environ_ping_p1_vc <= 3)));
}
