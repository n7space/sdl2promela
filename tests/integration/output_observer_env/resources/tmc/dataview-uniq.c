...
flag asn1SccEnviron_pong_p1_Encode(const asn1SccEnviron_pong_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccEnviron_pong_p1_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    ret = asn1SccMyInteger_Encode(pVal, pBitStrm, pErrCode, FALSE);
    } /*COVERAGE_IGNORE*/
...
flag asn1SccEnviron_pong_p1_Decode(asn1SccEnviron_pong_p1* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = asn1SccMyInteger_Decode(pVal, pBitStrm, pErrCode);

	return ret  && asn1SccEnviron_pong_p1_IsConstraintValid(pVal, pErrCode);
}
...
flag asn1SccEnviron_ping_p1_Encode(const asn1SccEnviron_ping_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccEnviron_ping_p1_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    ret = asn1SccMyInteger_Encode(pVal, pBitStrm, pErrCode, FALSE);
    } /*COVERAGE_IGNORE*/
...
flag asn1SccEnviron_ping_p1_Decode(asn1SccEnviron_ping_p1* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	return ret  && asn1SccEnviron_ping_p1_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = ((((((*(pVal)) == PID_controller)) || (((*(pVal)) == PID_environ)))) || (((*(pVal)) == PID_env)));
