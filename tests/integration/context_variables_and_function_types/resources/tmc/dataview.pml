...
#define Worker_Context__state int
#define Worker_Context__init_done bool
#define Worker_Context__sender int
#define Worker_Context__offspring int
#define Worker_Context__check_param int
#define Worker_Context__result_param int
#define Worker_T_Runtime_Error_Selection int
#define Context_worker__coeff int
...
#define Controller_Context__check_param int
...
#define Worker_Context__state_wait 0
#define Worker_Context__sender_taste_user_interface 0
#define Worker_Context__sender_timer_manager 1
#define Worker_Context__sender_actuator 2
#define Worker_Context__sender_controller 3
#define Worker_Context__sender_env 4
#define Worker_Context__offspring_taste_user_interface 0
#define Worker_Context__offspring_timer_manager 1
#define Worker_Context__offspring_actuator 2
#define Worker_Context__offspring_controller 3
#define Worker_Context__offspring_env 4
...
typedef Controller_Context {
    ...
    Controller_Context__check_param check_param;
...
typedef Worker_Context {
    Worker_Context__state state;
    Worker_Context__init_done init_done;
    Worker_Context__sender sender;
    Worker_Context__offspring offspring;
    Worker_Context__check_param check_param;
    Worker_Context__result_param result_param;
}
...
inline Worker_Context__state_assign_value(dst, src)
{
    dst = src;
    Worker_Context__state_range_check(dst);
}
inline Worker_Context__state_range_check(Worker_Context__state_vc)
{
    assert((Worker_Context__state_vc == Worker_Context__state_wait));
}
inline Worker_Context__init_done_assign_value(dst, src)
{
    dst = src;
    Worker_Context__init_done_range_check(dst);
}
inline Worker_Context__init_done_range_check(Worker_Context__init_done_vc)
{
    assert(true);
}
inline Worker_Context__sender_assign_value(dst, src)
{
    dst = src;
    Worker_Context__sender_range_check(dst);
}
inline Worker_Context__sender_range_check(Worker_Context__sender_vc)
{
    assert((((((Worker_Context__sender_vc == Worker_Context__sender_taste_user_interface) || (Worker_Context__sender_vc == Worker_Context__sender_timer_manager)) || (Worker_Context__sender_vc == Worker_Context__sender_actuator)) || (Worker_Context__sender_vc == Worker_Context__sender_controller)) || (Worker_Context__sender_vc == Worker_Context__sender_env)));
}
inline Worker_Context__offspring_assign_value(dst, src)
{
    dst = src;
    Worker_Context__offspring_range_check(dst);
}
inline Worker_Context__offspring_range_check(Worker_Context__offspring_vc)
{
    assert((((((Worker_Context__offspring_vc == Worker_Context__offspring_taste_user_interface) || (Worker_Context__offspring_vc == Worker_Context__offspring_timer_manager)) || (Worker_Context__offspring_vc == Worker_Context__offspring_actuator)) || (Worker_Context__offspring_vc == Worker_Context__offspring_controller)) || (Worker_Context__offspring_vc == Worker_Context__offspring_env)));
}
inline Worker_Context__check_param_assign_value(dst, src)
{
    dst = src;
    Worker_Context__check_param_range_check(dst);
}
inline Worker_Context__check_param_range_check(Worker_Context__check_param_vc)
{
    assert(((Worker_Context__check_param_vc >= 0) && (Worker_Context__check_param_vc <= 100)));
}
inline Worker_Context__result_param_assign_value(dst, src)
{
    dst = src;
    Worker_Context__result_param_range_check(dst);
}
inline Worker_Context__result_param_range_check(Worker_Context__result_param_vc)
{
    assert(((Worker_Context__result_param_vc >= 0) && (Worker_Context__result_param_vc <= 100)));
}
inline Worker_Context_assign_value(dst, src)
{
    Worker_Context__state_assign_value(dst.state, src.state);
    Worker_Context__init_done_assign_value(dst.init_done, src.init_done);
    Worker_Context__sender_assign_value(dst.sender, src.sender);
    Worker_Context__offspring_assign_value(dst.offspring, src.offspring);
    Worker_Context__check_param_assign_value(dst.check_param, src.check_param);
    Worker_Context__result_param_assign_value(dst.result_param, src.result_param);
}
...
inline Context_worker__coeff_assign_value(dst, src)
{
    dst = src;
    Context_worker__coeff_range_check(dst);
}
inline Context_worker__coeff_range_check(Context_worker__coeff_vc)
{
    assert(((Context_worker__coeff_vc >= 0) && (Context_worker__coeff_vc <= 100)));
}
inline Context_worker_assign_value(dst, src)
{
    Context_worker__coeff_assign_value(dst.coeff, src.coeff);
}
...
inline Controller_Context__check_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context__check_param_range_check(dst);
}
inline Controller_Context__check_param_range_check(Controller_Context__check_param_vc)
{
    assert(((Controller_Context__check_param_vc >= 0) && (Controller_Context__check_param_vc <= 100)));
}
...
{
    assert(((Controller_Context__result_param_vc >= 0) && (Controller_Context__result_param_vc <= 100)));
}
...
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__check_param_assign_value(dst.check_param, src.check_param);
