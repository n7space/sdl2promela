...
#define Actuator_Context__ping_param int
#define Actuator_Context__pong_param int
...
#define Actuator_States_repeat 0
#define Actuator_States_add 1
#define Actuator_Context__state_repeat 0
#define Actuator_Context__state_add 1
...
typedef Actuator_Context {
    ...
    Actuator_Context__ping_param ping_param;
    Actuator_Context__pong_param pong_param;
}
...
{
    assert(((Actuator_States_vc == Actuator_States_repeat) || (Actuator_States_vc == Actuator_States_add)));
}
...
{
    assert(((Actuator_Context__state_vc == Actuator_Context__state_repeat) || (Actuator_Context__state_vc == Actuator_Context__state_add)));
}
...
inline Actuator_Context__ping_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__ping_param_range_check(dst);
}
inline Actuator_Context__ping_param_range_check(Actuator_Context__ping_param_vc)
{
    assert(((Actuator_Context__ping_param_vc >= 0) && (Actuator_Context__ping_param_vc <= 10000)));
}
inline Actuator_Context__pong_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__pong_param_range_check(dst);
}
inline Actuator_Context__pong_param_range_check(Actuator_Context__pong_param_vc)
{
    assert(((Actuator_Context__pong_param_vc >= 0) && (Actuator_Context__pong_param_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__ping_param_assign_value(dst.ping_param, src.ping_param);
    Actuator_Context__pong_param_assign_value(dst.pong_param, src.pong_param);
}
