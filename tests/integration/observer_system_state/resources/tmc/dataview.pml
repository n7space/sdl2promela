...
#define System_State_actuator_pong_param int
...
#define System_State_actuator_state_add 0
#define System_State_actuator_state_repeat 1
...
typedef System_State_actuator {
    ...
    System_State_actuator_pong_param pong_param;
}
...
{
    assert(((System_State_actuator_state_vc == System_State_actuator_state_add) || (System_State_actuator_state_vc == System_State_actuator_state_repeat)));
}
...
inline System_State_actuator_pong_param_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_pong_param_range_check(dst);
}
inline System_State_actuator_pong_param_range_check(System_State_actuator_pong_param_vc)
{
    assert(((System_State_actuator_pong_param_vc >= 0) && (System_State_actuator_pong_param_vc <= 10000)));
}
inline System_State_actuator_assign_value(dst, src)
{
    ...
    System_State_actuator_pong_param_assign_value(dst.pong_param, src.pong_param);
}
