...
typedef MyTestParameterMessage {
#if asn1SccMyTestParameter_REQUIRED_BYTES_FOR_ENCODING == 0
    byte data[1];
#else
    byte data[asn1SccMyTestParameter_REQUIRED_BYTES_FOR_ENCODING];
#endif
}
...
int inited;
chan Actuator_work_channel = [1] of {MyTestParameterMessage};
MyTestParameter Actuator_work_signal_parameter;
MyTestParameterMessage Actuator_work_signal_parameter_message;
...
MyTestParameterMessage controller_work_Controller_work_p1_message;
MyTestParameter controller_work_Controller_work_p1_var;
...
{
    MyTestParameter_assign_value(controller_work_Controller_work_p1_var, controller_work_Controller_work_p1);
    c_code {
        {
        asn1SccMyTestParameter controller_work_Controller_work_p1_c_var;
        ...
        controller_work_Controller_work_p1_c_var.nCount = now.controller_work_Controller_work_p1_var.length;
        
        BitStream_Init(&controller_work_Controller_work_p1_stream,
            now.controller_work_Controller_work_p1_message.data,
            asn1SccMyTestParameter_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccMyTestParameter_Encode(&controller_work_Controller_work_p1_c_var,
    ...
    printf("channel_send Actuator_work_channel: %d, %d, %d, %d, %d, %d\n", controller_work_Controller_work_p1_var.length, controller_work_Controller_work_p1_var.data[0], controller_work_Controller_work_p1_var.data[1], controller_work_Controller_work_p1_var.data[2], controller_work_Controller_work_p1_var.data[3], controller_work_Controller_work_p1_var.data[4]);
}
...
Actuator_work_loop:
        ...
        ::  nempty(Actuator_work_channel);
            ...
            c_code {
                {
                asn1SccMyTestParameter Actuator_work_signal_parameter_c_var;
                ...
                int Actuator_work_signal_parameter_rc;BitStream_AttachBuffer(&Actuator_work_signal_parameter_stream,
                    ...
                    asn1SccMyTestParameter_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccMyTestParameter_Decode(&Actuator_work_signal_parameter_c_var,
                ...
                now.Actuator_work_signal_parameter.length = Actuator_work_signal_parameter_c_var.nCount;
                }
            }
            printf("channel_recv Actuator_work_channel: %d, %d, %d, %d, %d, %d\n", Actuator_work_signal_parameter.length, Actuator_work_signal_parameter.data[0], Actuator_work_signal_parameter.data[1], Actuator_work_signal_parameter.data[2], Actuator_work_signal_parameter.data[3], Actuator_work_signal_parameter.data[4]);
