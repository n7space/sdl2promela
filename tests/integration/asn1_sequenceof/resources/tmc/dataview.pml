...
#define Actuator_Context_work_param_elem int
...
#define Controller_Context_work_param_elem int
...
#define MyTestParameter_elem int
#define T_Int32 int
#define T_UInt32 int
#define T_Int8 int
#define T_UInt8 int
...
typedef Actuator_Context_work_param {
    Actuator_Context_work_param_elem data[5];
    int length;
}
...
typedef Controller_Context_work_param {
    Controller_Context_work_param_elem data[5];
    int length;
}
...
inline Actuator_Context_work_param_elem_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_work_param_elem_range_check(dst);
}
inline Actuator_Context_work_param_elem_range_check(Actuator_Context_work_param_elem_vc)
{
    assert(((Actuator_Context_work_param_elem_vc >= 0) && (Actuator_Context_work_param_elem_vc <= 10000)));
}
inline Actuator_Context_work_param_elem_init_value(dst)
{
    Actuator_Context_work_param_elem_assign_value(dst, 0);
}
inline Actuator_Context_work_param_assign_value(dst, src)
{
    ...
    {
        Actuator_Context_work_param_elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
    for(i_1 : src.length .. 4)
    {
        Actuator_Context_work_param_elem_init_value(dst.data[i_1]);
    }
    dst.length = src.length;
}
inline Actuator_Context_work_param_size_check(Actuator_Context_work_param_sc)
{
    assert(((Actuator_Context_work_param_sc >= 1) && (Actuator_Context_work_param_sc <= 5)));
}
...
inline Controller_Context_work_param_elem_assign_value(dst, src)
{
    dst = src;
    Controller_Context_work_param_elem_range_check(dst);
}
inline Controller_Context_work_param_elem_range_check(Controller_Context_work_param_elem_vc)
{
    assert(((Controller_Context_work_param_elem_vc >= 0) && (Controller_Context_work_param_elem_vc <= 10000)));
}
inline Controller_Context_work_param_elem_init_value(dst)
{
    Controller_Context_work_param_elem_assign_value(dst, 0);
}
inline Controller_Context_work_param_assign_value(dst, src)
{
    ...
    for(i_1 : 0 .. (src.length - 1))
    {
        Controller_Context_work_param_elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
    for(i_1 : src.length .. 4)
    {
        Controller_Context_work_param_elem_init_value(dst.data[i_1]);
    }
    dst.length = src.length;
}
inline Controller_Context_work_param_size_check(Controller_Context_work_param_sc)
{
    assert(((Controller_Context_work_param_sc >= 1) && (Controller_Context_work_param_sc <= 5)));
}
...
{
    dst = src;
    MyTestParameter_elem_range_check(dst);
}
inline MyTestParameter_elem_range_check(MyTestParameter_elem_vc)
{
    assert(((MyTestParameter_elem_vc >= 0) && (MyTestParameter_elem_vc <= 10000)));
}
inline MyTestParameter_elem_init_value(dst)
{
    MyTestParameter_elem_assign_value(dst, 0);
}
inline MyTestParameter_assign_value(dst, src)
{
    ...
    {
        MyTestParameter_elem_assign_value(dst.data[i_0], src.data[i_0]);
    }
    for(i_0 : src.length .. 4)
    {
        MyTestParameter_elem_init_value(dst.data[i_0]);
    }
    dst.length = src.length;
}
