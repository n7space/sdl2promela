...
#define Observer_Context_indicator int
...
typedef Observer_Context {
    ...
    Observer_Context_indicator indicator;
}
...
inline Observer_Context_indicator_assign_value(dst, src)
{
    dst = src;
    Observer_Context_indicator_range_check(dst);
}
inline Observer_Context_indicator_range_check(Observer_Context_indicator_vc)
{
    assert(((Observer_Context_indicator_vc >= 0) && (Observer_Context_indicator_vc <= 10000)));
}
inline Observer_Context_assign_value(dst, src)
{
    ...
    Observer_Context_indicator_assign_value(dst.indicator, src.indicator);
}
