...
#define Observer_Context__indicator int
...
typedef Observer_Context {
    ...
    Observer_Context__indicator indicator;
}
...
inline Observer_Context__indicator_assign_value(dst, src)
{
    dst = src;
    Observer_Context__indicator_range_check(dst);
}
inline Observer_Context__indicator_range_check(Observer_Context__indicator_vc)
{
    assert(((Observer_Context__indicator_vc >= 0) && (Observer_Context__indicator_vc <= 10000)));
}
inline Observer_Context_assign_value(dst, src)
{
    ...
    Observer_Context__indicator_assign_value(dst.indicator, src.indicator);
}
