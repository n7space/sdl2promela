...
typedef BinaryBooleanTestParamMessage {
#if asn1SccBinaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING == 0
    byte data[1];
#else
    byte data[asn1SccBinaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING];
#endif
}

typedef MyBooleanResultMessage {
#if asn1SccMyBooleanResult_REQUIRED_BYTES_FOR_ENCODING == 0
    byte data[1];
#else
    byte data[asn1SccMyBooleanResult_REQUIRED_BYTES_FOR_ENCODING];
#endif
}

typedef UnaryBooleanTestParamMessage {
#if asn1SccUnaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING == 0
    byte data[1];
#else
    byte data[asn1SccUnaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING];
#endif
}
...
int inited;
chan Actuator_check_binary_channel = [1] of {BinaryBooleanTestParamMessage};
BinaryBooleanTestParam Actuator_check_binary_signal_parameter;
BinaryBooleanTestParamMessage Actuator_check_binary_signal_parameter_message;
bool Actuator_check_binary_channel_used = 0;
chan Actuator_check_unary_channel = [1] of {UnaryBooleanTestParamMessage};
UnaryBooleanTestParam Actuator_check_unary_signal_parameter;
UnaryBooleanTestParamMessage Actuator_check_unary_signal_parameter_message;
bool Actuator_check_unary_channel_used = 0;
MyBooleanResultMessage actuator_result_Actuator_result_p1_message;
MyBooleanResult actuator_result_Actuator_result_p1_var;
chan Controller_result_channel = [1] of {MyBooleanResultMessage};
MyBooleanResult Controller_result_signal_parameter;
MyBooleanResultMessage Controller_result_signal_parameter_message;
bool Controller_result_channel_used = 0;
BinaryBooleanTestParamMessage controller_check_binary_Controller_check_binary_p1_message;
BinaryBooleanTestParam controller_check_binary_Controller_check_binary_p1_var;
UnaryBooleanTestParamMessage controller_check_unary_Controller_check_unary_p1_message;
UnaryBooleanTestParam controller_check_unary_Controller_check_unary_p1_var;
...
{
    MyBooleanResult_assign_value(actuator_result_Actuator_result_p1_var, actuator_result_Actuator_result_p1);
    c_code {
        {
        asn1SccMyBooleanResult actuator_result_Actuator_result_p1_c_var;
        ...
        BitStream_Init(&actuator_result_Actuator_result_p1_stream,
            ...
            asn1SccMyBooleanResult_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccMyBooleanResult_Encode(&actuator_result_Actuator_result_p1_c_var,
...
{
    BinaryBooleanTestParam_assign_value(controller_check_binary_Controller_check_binary_p1_var, controller_check_binary_Controller_check_binary_p1);
    c_code {
        {
        asn1SccBinaryBooleanTestParam controller_check_binary_Controller_check_binary_p1_c_var;
        ...
        BitStream_Init(&controller_check_binary_Controller_check_binary_p1_stream,
            ...
            asn1SccBinaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccBinaryBooleanTestParam_Encode(&controller_check_binary_Controller_check_binary_p1_c_var,
...
{
    UnaryBooleanTestParam_assign_value(controller_check_unary_Controller_check_unary_p1_var, controller_check_unary_Controller_check_unary_p1);
    c_code {
        {
        asn1SccUnaryBooleanTestParam controller_check_unary_Controller_check_unary_p1_c_var;
        ...
        BitStream_Init(&controller_check_unary_Controller_check_unary_p1_stream,
            ...
            asn1SccUnaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccUnaryBooleanTestParam_Encode(&controller_check_unary_Controller_check_unary_p1_c_var,
...
Actuator_check_binary_loop:
        ...
        ::  nempty(Actuator_check_binary_channel);
            ...
            c_code {
                {
                asn1SccBinaryBooleanTestParam Actuator_check_binary_signal_parameter_c_var;
                ...
                int Actuator_check_binary_signal_parameter_rc;BitStream_AttachBuffer(&Actuator_check_binary_signal_parameter_stream,
                    ...
                    asn1SccBinaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccBinaryBooleanTestParam_Decode(&Actuator_check_binary_signal_parameter_c_var,
...
Actuator_check_unary_loop:
        ...
        ::  nempty(Actuator_check_unary_channel);
            ...
            c_code {
                {
                asn1SccUnaryBooleanTestParam Actuator_check_unary_signal_parameter_c_var;
                ...
                int Actuator_check_unary_signal_parameter_rc;BitStream_AttachBuffer(&Actuator_check_unary_signal_parameter_stream,
                    ...
                    asn1SccUnaryBooleanTestParam_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccUnaryBooleanTestParam_Decode(&Actuator_check_unary_signal_parameter_c_var,
...
Controller_result_loop:
        ...
        ::  nempty(Controller_result_channel);
            ...
            c_code {
                {
                asn1SccMyBooleanResult Controller_result_signal_parameter_c_var;
                ...
                int Controller_result_signal_parameter_rc;BitStream_AttachBuffer(&Controller_result_signal_parameter_stream,
                    ...
                    asn1SccMyBooleanResult_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccMyBooleanResult_Decode(&Controller_result_signal_parameter_c_var,
