...
{
    flag ret = TRUE;
    ret = asn1SccMyInteger_IsConstraintValid((&(pVal->camelCase)), pErrCode);
    if (ret) {
        ret = asn1SccMyInteger_IsConstraintValid((&(pVal->lowercase)), pErrCode);
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMySeq_Initialize(asn1SccMySeq* pVal)
{
	...
	/*set camelCase */
	asn1SccMyInteger_Initialize((&(pVal->camelCase)));
	/*set lowercase */
	asn1SccMyInteger_Initialize((&(pVal->lowercase)));
}
...
flag asn1SccMySeq_Encode(const asn1SccMySeq* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    /*Encode camelCase */
	    ret = asn1SccMyInteger_Encode((&(pVal->camelCase)), pBitStrm, pErrCode, FALSE);
	    if (ret) {
	        /*Encode lowercase */
	        ret = asn1SccMyInteger_Encode((&(pVal->lowercase)), pBitStrm, pErrCode, FALSE);
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMySeq_Decode(asn1SccMySeq* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode camelCase */
	ret = asn1SccMyInteger_Decode((&(pVal->camelCase)), pBitStrm, pErrCode);
	if (ret) {
	    /*Decode lowercase */
	    ret = asn1SccMyInteger_Decode((&(pVal->lowercase)), pBitStrm, pErrCode);
	}   /*COVERAGE_IGNORE*/
...
{
    flag ret = TRUE;
    if (pVal->kind == MyChoice_camelCaseAlternative_PRESENT) {
    	ret = asn1SccMyInteger_IsConstraintValid((&(pVal->u.camelCaseAlternative)), pErrCode);
    }
    if (ret) {
        if (pVal->kind == MyChoice_lowercase_alternative_PRESENT) {
        	ret = asn1SccMyInteger_IsConstraintValid((&(pVal->u.lowercase_alternative)), pErrCode);
        }
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyChoice_Initialize(asn1SccMyChoice* pVal)
{
	...
	pVal->kind = MyChoice_camelCaseAlternative_PRESENT;
	pVal->u.camelCaseAlternative = 0UL;
}
...
flag asn1SccMyChoice_Encode(const asn1SccMyChoice* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    switch(pVal->kind)
	    {
	    case MyChoice_camelCaseAlternative_PRESENT:
	    	BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 1);
	    	ret = asn1SccMyInteger_Encode((&(pVal->u.camelCaseAlternative)), pBitStrm, pErrCode, FALSE);
	    	break;
	    case MyChoice_lowercase_alternative_PRESENT:
	    	BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 1);
	    	ret = asn1SccMyInteger_Encode((&(pVal->u.lowercase_alternative)), pBitStrm, pErrCode, FALSE);
	    	break;
...
flag asn1SccMyChoice_Decode(asn1SccMyChoice* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYCHOICE;
	if (ret) {
	    ...
	    case 0:
	    	pVal->kind = MyChoice_camelCaseAlternative_PRESENT;
	    	ret = asn1SccMyInteger_Decode((&(pVal->u.camelCaseAlternative)), pBitStrm, pErrCode);
	    	break;
	    case 1:
	    	pVal->kind = MyChoice_lowercase_alternative_PRESENT;
	    	ret = asn1SccMyInteger_Decode((&(pVal->u.lowercase_alternative)), pBitStrm, pErrCode);
	    	break;
	    default:                        /*COVERAGE_IGNORE*/
