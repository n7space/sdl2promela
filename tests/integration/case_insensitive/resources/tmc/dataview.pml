...
#define System_State_actuator_mysecondseq_camelCase int
#define System_State_actuator_mysecondseq_lowercase int
#define System_State_actuator_mychoice_camelCaseAlternative int
#define System_State_actuator_mychoice_lowercase_alternative int
#define System_State_actuator_mysecondchoice_camelCaseAlternative int
...
#define System_State_actuator_mychoice_lowercase_alternative_PRESENT 2
#define System_state_actuator_mychoice_selection_lowercase_alternative_PRESENT 2
#define System_State_actuator_mysecondchoice_NONE 0
#define System_State_actuator_mysecondchoice_camelCaseAlternative_PRESENT 1
...
typedef System_State_actuator_mychoice_data {
    System_State_actuator_mychoice_camelCaseAlternative camelCaseAlternative;
    System_State_actuator_mychoice_lowercase_alternative lowercase_alternative;
}

typedef System_State_actuator_mysecondchoice_data {
    System_State_actuator_mysecondchoice_camelCaseAlternative camelCaseAlternative;
    System_State_actuator_mysecondchoice_lowercase_alternative lowercase_alternative;
}

typedef System_State_actuator_mysecondseq {
    System_State_actuator_mysecondseq_camelCase camelCase;
    System_State_actuator_mysecondseq_lowercase lowercase;
}

typedef System_State_actuator_myseq {
    System_State_actuator_myseq_camelCase camelCase;
    System_State_actuator_myseq_lowercase lowercase;
}
...
typedef System_State_actuator_mychoice {
    System_State_actuator_mychoice_data data;
    int selection;
}

typedef System_State_actuator_mysecondchoice {
    System_State_actuator_mysecondchoice_data data;
    int selection;
}
...
typedef System_State_actuator {
    ...
    System_State_actuator_mychoice mychoice;
    System_State_actuator_mysecondchoice mysecondchoice;
}
...
{
    dst = src;
    System_State_actuator_myparam_range_check(dst);
}
inline System_State_actuator_myparam_range_check(System_State_actuator_myparam_vc)
{
    assert(((System_State_actuator_myparam_vc >= 0) && (System_State_actuator_myparam_vc <= 10000)));
}
inline System_State_actuator_myseq_camelCase_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_myseq_camelCase_range_check(dst);
}
inline System_State_actuator_myseq_camelCase_range_check(System_State_actuator_myseq_camelCase_vc)
{
    assert(((System_State_actuator_myseq_camelCase_vc >= 0) && (System_State_actuator_myseq_camelCase_vc <= 10000)));
}
inline System_State_actuator_myseq_lowercase_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_myseq_lowercase_range_check(dst);
}
inline System_State_actuator_myseq_lowercase_range_check(System_State_actuator_myseq_lowercase_vc)
{
    assert(((System_State_actuator_myseq_lowercase_vc >= 0) && (System_State_actuator_myseq_lowercase_vc <= 10000)));
}
inline System_State_actuator_myseq_assign_value(dst, src)
{
    System_State_actuator_myseq_camelCase_assign_value(dst.camelCase, src.camelCase);
    System_State_actuator_myseq_lowercase_assign_value(dst.lowercase, src.lowercase);
}
inline System_State_actuator_mysecondseq_camelCase_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mysecondseq_camelCase_range_check(dst);
}
inline System_State_actuator_mysecondseq_camelCase_range_check(System_State_actuator_mysecondseq_camelCase_vc)
{
    assert(((System_State_actuator_mysecondseq_camelCase_vc >= 0) && (System_State_actuator_mysecondseq_camelCase_vc <= 10000)));
}
inline System_State_actuator_mysecondseq_lowercase_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mysecondseq_lowercase_range_check(dst);
}
inline System_State_actuator_mysecondseq_lowercase_range_check(System_State_actuator_mysecondseq_lowercase_vc)
{
    assert(((System_State_actuator_mysecondseq_lowercase_vc >= 0) && (System_State_actuator_mysecondseq_lowercase_vc <= 10000)));
}
inline System_State_actuator_mysecondseq_assign_value(dst, src)
{
    System_State_actuator_mysecondseq_camelCase_assign_value(dst.camelCase, src.camelCase);
    System_State_actuator_mysecondseq_lowercase_assign_value(dst.lowercase, src.lowercase);
}
inline System_State_actuator_mychoice_camelCaseAlternative_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mychoice_camelCaseAlternative_range_check(dst);
}
inline System_State_actuator_mychoice_camelCaseAlternative_range_check(System_State_actuator_mychoice_camelCaseAlternative_vc)
{
    assert(((System_State_actuator_mychoice_camelCaseAlternative_vc >= 0) && (System_State_actuator_mychoice_camelCaseAlternative_vc <= 10000)));
}
inline System_State_actuator_mychoice_lowercase_alternative_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mychoice_lowercase_alternative_range_check(dst);
}
inline System_State_actuator_mychoice_lowercase_alternative_range_check(System_State_actuator_mychoice_lowercase_alternative_vc)
{
    assert(((System_State_actuator_mychoice_lowercase_alternative_vc >= 0) && (System_State_actuator_mychoice_lowercase_alternative_vc <= 10000)));
}
inline System_State_actuator_mychoice_assign_value(dst, src)
{
    dst.selection = src.selection;
    if
    ::  (dst.selection == System_State_actuator_mychoice_camelCaseAlternative_PRESENT);
        System_State_actuator_mychoice_camelCaseAlternative_assign_value(dst.data.camelCaseAlternative, src.data.camelCaseAlternative);
    ::  (dst.selection == System_State_actuator_mychoice_lowercase_alternative_PRESENT);
        System_State_actuator_mychoice_lowercase_alternative_assign_value(dst.data.lowercase_alternative, src.data.lowercase_alternative);
    ::  else;
        skip;
    fi;
}
inline System_state_actuator_mychoice_selection_assign_value(dst, src)
{
    dst = src;
}
inline System_State_actuator_mysecondchoice_camelCaseAlternative_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mysecondchoice_camelCaseAlternative_range_check(dst);
}
inline System_State_actuator_mysecondchoice_camelCaseAlternative_range_check(System_State_actuator_mysecondchoice_camelCaseAlternative_vc)
{
    assert(((System_State_actuator_mysecondchoice_camelCaseAlternative_vc >= 0) && (System_State_actuator_mysecondchoice_camelCaseAlternative_vc <= 10000)));
}
inline System_State_actuator_mysecondchoice_lowercase_alternative_assign_value(dst, src)
{
    dst = src;
    System_State_actuator_mysecondchoice_lowercase_alternative_range_check(dst);
}
inline System_State_actuator_mysecondchoice_lowercase_alternative_range_check(System_State_actuator_mysecondchoice_lowercase_alternative_vc)
{
    assert(((System_State_actuator_mysecondchoice_lowercase_alternative_vc >= 0) && (System_State_actuator_mysecondchoice_lowercase_alternative_vc <= 10000)));
}
inline System_State_actuator_mysecondchoice_assign_value(dst, src)
{
    dst.selection = src.selection;
    if
    ::  (dst.selection == System_State_actuator_mysecondchoice_camelCaseAlternative_PRESENT);
        System_State_actuator_mysecondchoice_camelCaseAlternative_assign_value(dst.data.camelCaseAlternative, src.data.camelCaseAlternative);
    ::  (dst.selection == System_State_actuator_mysecondchoice_lowercase_alternative_PRESENT);
        System_State_actuator_mysecondchoice_lowercase_alternative_assign_value(dst.data.lowercase_alternative, src.data.lowercase_alternative);
    ::  else;
        skip;
    fi;
}
inline System_state_actuator_mysecondchoice_selection_assign_value(dst, src)
{
    dst = src;
}
inline System_State_actuator_assign_value(dst, src)
{
    ...
    System_State_actuator_mychoice_assign_value(dst.mychoice, src.mychoice);
    System_State_actuator_mysecondchoice_assign_value(dst.mysecondchoice, src.mysecondchoice);
}
