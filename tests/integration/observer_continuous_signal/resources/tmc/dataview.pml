...
#define Controller_Context__x int
...
inline Controller_Context__x_assign_value(dst, src)
{
    dst = src;
    Controller_Context__x_range_check(dst);
}
inline Controller_Context__x_range_check(Controller_Context__x_vc)
{
    assert(((Controller_Context__x_vc >= 0) && (Controller_Context__x_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__x_assign_value(dst.x, src.x);
}
