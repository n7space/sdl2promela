...
#define System_State_controller_x int
...
inline System_State_controller_x_assign_value(dst, src)
{
    dst = src;
    System_State_controller_x_range_check(dst);
}
inline System_State_controller_x_range_check(System_State_controller_x_vc)
{
    assert(((System_State_controller_x_vc >= 0) && (System_State_controller_x_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_x_assign_value(dst.x, src.x);
}
