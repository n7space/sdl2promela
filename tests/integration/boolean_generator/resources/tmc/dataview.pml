...
#define Controller_Context__p1 bool
#define Controller_Context__valreceived bool
...
#define PID int
#define Environment_readvalue_p1 bool
...
#define Controller_Context__sender_environment 1
#define Controller_Context__sender_env 2
#define Controller_Context__offspring_controller 0
#define Controller_Context__offspring_environment 1
...
typedef Controller_Context {
    ...
    Controller_Context__p1 p1;
    Controller_Context__valreceived valreceived;
}
...
{
    assert((((Controller_Context__sender_vc == Controller_Context__sender_controller) || (Controller_Context__sender_vc == Controller_Context__sender_environment)) || (Controller_Context__sender_vc == Controller_Context__sender_env)));
}
...
{
    assert((((Controller_Context__offspring_vc == Controller_Context__offspring_controller) || (Controller_Context__offspring_vc == Controller_Context__offspring_environment)) || (Controller_Context__offspring_vc == Controller_Context__offspring_env)));
}
inline Controller_Context__p1_assign_value(dst, src)
{
    dst = src;
    Controller_Context__p1_range_check(dst);
}
inline Controller_Context__p1_range_check(Controller_Context__p1_vc)
{
    assert(true);
}
inline Controller_Context__valreceived_assign_value(dst, src)
{
    dst = src;
    Controller_Context__valreceived_range_check(dst);
}
inline Controller_Context__valreceived_range_check(Controller_Context__valreceived_vc)
{
    assert(true);
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__p1_assign_value(dst.p1, src.p1);
    Controller_Context__valreceived_assign_value(dst.valreceived, src.valreceived);
}
...
{
    dst = src;
    MyBool_range_check(dst);
}
inline MyBool_range_check(MyBool_vc)
{
    assert(true);
}
...
{
    assert((((PID_vc == PID_controller) || (PID_vc == PID_environment)) || (PID_vc == PID_env)));
}
inline Environment_readvalue_p1_assign_value(dst, src)
{
    dst = src;
    Environment_readvalue_p1_range_check(dst);
}
inline Environment_readvalue_p1_range_check(Environment_readvalue_p1_vc)
{
    assert(true);
}
