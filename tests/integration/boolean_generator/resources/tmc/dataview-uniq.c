...
flag asn1SccMyBool_Decode(asn1SccMyBool* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYBOOL;

	return ret  && asn1SccMyBool_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = asn1SccMyBool_IsConstraintValid(pVal, pErrCode);
...
flag asn1SccEnvironment_readvalue_p1_Encode(const asn1SccEnvironment_readvalue_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccEnvironment_readvalue_p1_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    ret = asn1SccMyBool_Encode(pVal, pBitStrm, pErrCode, FALSE);
    } /*COVERAGE_IGNORE*/
...
flag asn1SccEnvironment_readvalue_p1_Decode(asn1SccEnvironment_readvalue_p1* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	ret = asn1SccMyBool_Decode(pVal, pBitStrm, pErrCode);

	return ret  && asn1SccEnvironment_readvalue_p1_IsConstraintValid(pVal, pErrCode);
}
...
{
    flag ret = TRUE;
    ret = ((((((*(pVal)) == PID_controller)) || (((*(pVal)) == PID_environment)))) || (((*(pVal)) == PID_env)));
