...
#define ERR_UPER_ENCODE_MYBOOL		2  /**/
...
#define ERR_UPER_DECODE_MYBOOL		3  /**/
flag asn1SccMyBool_Decode(asn1SccMyBool* pVal, BitStream* pBitStrm, int* pErrCode);
typedef asn1SccMyBool asn1SccEnvironment_readvalue_p1;


#define ERR_ENVIRONMENT_READVALUE_P1_2		86  /**/
flag asn1SccEnvironment_readvalue_p1_IsConstraintValid(const asn1SccEnvironment_readvalue_p1* pVal, int* pErrCode);

void asn1SccEnvironment_readvalue_p1_Initialize(asn1SccEnvironment_readvalue_p1* pVal);

#define ERR_UPER_ENCODE_ENVIRONMENT_READVALUE_P1_2		87  /**/
#define asn1SccEnvironment_readvalue_p1_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccEnvironment_readvalue_p1_REQUIRED_BITS_FOR_ENCODING        1

flag asn1SccEnvironment_readvalue_p1_Encode(const asn1SccEnvironment_readvalue_p1* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_ENVIRONMENT_READVALUE_P1_2		88  /**/
flag asn1SccEnvironment_readvalue_p1_Decode(asn1SccEnvironment_readvalue_p1* pVal, BitStream* pBitStrm, int* pErrCode);
...
#define asn1SccPID_environment PID_environment
#define asn1SccPID_env PID_env

#define ERR_PID		76  /*controller | environment | env*/
