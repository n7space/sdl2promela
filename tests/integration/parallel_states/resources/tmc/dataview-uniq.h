...
typedef enum {
    MyStatus_transition_top = 0,
    MyStatus_enter_parallel = 1,
    MyStatus_transition_left_parallel = 2,
    MyStatus_transition_right_parallel = 3,
    MyStatus_leave_parallel = 4
} asn1SccMyStatus;

// please use the following macros to avoid breaking code.
#define asn1SccMyStatus_transition_top MyStatus_transition_top
#define asn1SccMyStatus_enter_parallel MyStatus_enter_parallel
#define asn1SccMyStatus_transition_left_parallel MyStatus_transition_left_parallel
#define asn1SccMyStatus_transition_right_parallel MyStatus_transition_right_parallel
#define asn1SccMyStatus_leave_parallel MyStatus_leave_parallel

#define ERR_MYSTATUS		6  /*transition-top | enter-parallel | transition-left-parallel | transition-right-parallel | leave-parallel*/
...
#define ERR_UPER_ENCODE_MYSTATUS		7  /**/
#define asn1SccMyStatus_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccMyStatus_REQUIRED_BITS_FOR_ENCODING        3

flag asn1SccMyStatus_Encode(const asn1SccMyStatus* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_MYSTATUS		8  /**/
...
#define ERR_PID		81  /*taste-user-interface | timer-manager | actuator | controller | env*/
