...
#define Actuator_States_parallel_0_right_0_wait 5
...
#define Actuator_Context_parallel_0_right_0_state_parallel_0_right_0_wait 5
...
#define Actuator_Context_parallel_0_left_0_state_wait 0
#define Actuator_Context_parallel_0_left_0_state_state_0_end 1
#define Actuator_Context_parallel_0_left_0_state_parallel_0_left 2
...
#define Actuator_Context_parallel_0_left_0_state_parallel_0_right_0_wait 5
...
#define Controller_States_waitfortransitionrightparallel 3
#define Controller_States_error 4
#define Controller_States_waitforenterparallel 5
#define Controller_States_waitfortransitiontop 6
#define Controller_Context_state_waitfortransitionleftparallel 0
#define Controller_Context_state_finished 1
#define Controller_Context_state_waitforleaveparallel 2
#define Controller_Context_state_waitfortransitionrightparallel 3
#define Controller_Context_state_error 4
#define Controller_Context_state_waitforenterparallel 5
#define Controller_Context_state_waitfortransitiontop 6
...
{
    assert(((((((((Actuator_States_vc == Actuator_States_wait) || (Actuator_States_vc == Actuator_States_state_0_end)) || (Actuator_States_vc == Actuator_States_parallel_0_left)) || (Actuator_States_vc == Actuator_States_parallel_0_left_0_wait)) || (Actuator_States_vc == Actuator_States_first)) || (Actuator_States_vc == Actuator_States_parallel_0_right_0_wait)) || (Actuator_States_vc == Actuator_States_parallel_0_right)) || (Actuator_States_vc == Actuator_States_parallel)));
}
...
{
    assert(((((((((Actuator_Context_state_vc == Actuator_Context_state_wait) || (Actuator_Context_state_vc == Actuator_Context_state_state_0_end)) || (Actuator_Context_state_vc == Actuator_Context_state_parallel_0_left)) || (Actuator_Context_state_vc == Actuator_Context_state_parallel_0_left_0_wait)) || (Actuator_Context_state_vc == Actuator_Context_state_first)) || (Actuator_Context_state_vc == Actuator_Context_state_parallel_0_right_0_wait)) || (Actuator_Context_state_vc == Actuator_Context_state_parallel_0_right)) || (Actuator_Context_state_vc == Actuator_Context_state_parallel)));
}
...
{
    assert(((((((((Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_wait) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_state_0_end)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_parallel_0_left)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_parallel_0_left_0_wait)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_first)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_parallel_0_right_0_wait)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_parallel_0_right)) || (Actuator_Context_parallel_0_right_0_state_vc == Actuator_Context_parallel_0_right_0_state_parallel)));
}
...
{
    assert(((((((((Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_wait) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_state_0_end)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_parallel_0_left)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_parallel_0_left_0_wait)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_first)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_parallel_0_right_0_wait)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_parallel_0_right)) || (Actuator_Context_parallel_0_left_0_state_vc == Actuator_Context_parallel_0_left_0_state_parallel)));
}
...
{
    assert((((((((Controller_States_vc == Controller_States_waitfortransitionleftparallel) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforleaveparallel)) || (Controller_States_vc == Controller_States_waitfortransitionrightparallel)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforenterparallel)) || (Controller_States_vc == Controller_States_waitfortransitiontop)));
}
...
{
    assert((((((((Controller_Context_state_vc == Controller_Context_state_waitfortransitionleftparallel) || (Controller_Context_state_vc == Controller_Context_state_finished)) || (Controller_Context_state_vc == Controller_Context_state_waitforleaveparallel)) || (Controller_Context_state_vc == Controller_Context_state_waitfortransitionrightparallel)) || (Controller_Context_state_vc == Controller_Context_state_error)) || (Controller_Context_state_vc == Controller_Context_state_waitforenterparallel)) || (Controller_Context_state_vc == Controller_Context_state_waitfortransitiontop)));
}
