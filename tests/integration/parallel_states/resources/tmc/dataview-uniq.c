...
{
    flag ret = TRUE;
    ret = ((((((((((*(pVal)) == MyStatus_transition_top)) || (((*(pVal)) == MyStatus_enter_parallel)))) || (((*(pVal)) == MyStatus_transition_left_parallel)))) || (((*(pVal)) == MyStatus_transition_right_parallel)))) || (((*(pVal)) == MyStatus_leave_parallel)));
	    ...
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	                ...
	                break;
	            case 1:
	                (*(pVal)) = MyStatus_enter_parallel;
	                break;
	            case 2:
	                (*(pVal)) = MyStatus_transition_left_parallel;
	                break;
	            case 3:
	                (*(pVal)) = MyStatus_transition_right_parallel;
	                break;
	            case 4:
	                (*(pVal)) = MyStatus_leave_parallel;
	                break;
	            default:                        /*COVERAGE_IGNORE*/
	        ...
	        (*(pVal)) = MyStatus_transition_top;             /*COVERAGE_IGNORE*/
	    }
	}
