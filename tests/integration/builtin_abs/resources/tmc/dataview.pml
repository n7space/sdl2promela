...
#define Actuator_Context__ret int
...
#define Controller_Context__val int
#define Controller_Context__ret int
...
#define Controller_States_waitforpositive 0
#define Controller_States_waitforzero 1
#define Controller_States_error 2
#define Controller_States_waitfornegative 3
#define Controller_States_finished 4
#define Controller_Context__state_waitforpositive 0
#define Controller_Context__state_waitforzero 1
#define Controller_Context__state_error 2
#define Controller_Context__state_waitfornegative 3
...
typedef Controller_Context {
    ...
    Controller_Context__val val;
    Controller_Context__ret ret;
}
...
{
    assert(((Actuator_Context__param_vc >= -100) && (Actuator_Context__param_vc <= 100)));
}
inline Actuator_Context__ret_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__ret_range_check(dst);
}
inline Actuator_Context__ret_range_check(Actuator_Context__ret_vc)
{
    assert(((Actuator_Context__ret_vc >= -100) && (Actuator_Context__ret_vc <= 100)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__ret_assign_value(dst.ret, src.ret);
}
...
{
    assert((((((Controller_States_vc == Controller_States_waitforpositive) || (Controller_States_vc == Controller_States_waitforzero)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitfornegative)) || (Controller_States_vc == Controller_States_finished)));
}
...
{
    assert((((((Controller_Context__state_vc == Controller_Context__state_waitforpositive) || (Controller_Context__state_vc == Controller_Context__state_waitforzero)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitfornegative)) || (Controller_Context__state_vc == Controller_Context__state_finished)));
}
...
inline Controller_Context__val_assign_value(dst, src)
{
    dst = src;
    Controller_Context__val_range_check(dst);
}
inline Controller_Context__val_range_check(Controller_Context__val_vc)
{
    assert(((Controller_Context__val_vc >= -100) && (Controller_Context__val_vc <= 100)));
}
inline Controller_Context__ret_assign_value(dst, src)
{
    dst = src;
    Controller_Context__ret_range_check(dst);
}
inline Controller_Context__ret_range_check(Controller_Context__ret_vc)
{
    assert(((Controller_Context__ret_vc >= -100) && (Controller_Context__ret_vc <= 100)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__val_assign_value(dst.val, src.val);
    Controller_Context__ret_assign_value(dst.ret, src.ret);
}
...
{
    assert(((MyInteger_vc >= -100) && (MyInteger_vc <= 100)));
}
