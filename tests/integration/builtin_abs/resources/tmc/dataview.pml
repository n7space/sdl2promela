...
#define Actuator_Context_ret int
...
#define Controller_Context_val int
#define Controller_Context_ret int
...
#define Controller_States_waitfornegative 1
#define Controller_States_waitforzero 2
#define Controller_States_error 3
#define Controller_States_finished 4
#define Controller_Context_state_waitforpositive 0
#define Controller_Context_state_waitfornegative 1
#define Controller_Context_state_waitforzero 2
...
typedef Controller_Context {
    ...
    Controller_Context_val val;
    Controller_Context_ret ret;
}
...
{
    assert(((Actuator_Context_param_vc >= -100) && (Actuator_Context_param_vc <= 100)));
}
inline Actuator_Context_ret_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_ret_range_check(dst);
}
inline Actuator_Context_ret_range_check(Actuator_Context_ret_vc)
{
    assert(((Actuator_Context_ret_vc >= -100) && (Actuator_Context_ret_vc <= 100)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context_ret_assign_value(dst.ret, src.ret);
}
...
{
    assert((((((Controller_States_vc == Controller_States_waitforpositive) || (Controller_States_vc == Controller_States_waitfornegative)) || (Controller_States_vc == Controller_States_waitforzero)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_finished)));
}
...
{
    assert((((((Controller_Context_state_vc == Controller_Context_state_waitforpositive) || (Controller_Context_state_vc == Controller_Context_state_waitfornegative)) || (Controller_Context_state_vc == Controller_Context_state_waitforzero)) || (Controller_Context_state_vc == Controller_Context_state_error)) || (Controller_Context_state_vc == Controller_Context_state_finished)));
}
...
inline Controller_Context_val_assign_value(dst, src)
{
    dst = src;
    Controller_Context_val_range_check(dst);
}
inline Controller_Context_val_range_check(Controller_Context_val_vc)
{
    assert(((Controller_Context_val_vc >= -100) && (Controller_Context_val_vc <= 100)));
}
inline Controller_Context_ret_assign_value(dst, src)
{
    dst = src;
    Controller_Context_ret_range_check(dst);
}
inline Controller_Context_ret_range_check(Controller_Context_ret_vc)
{
    assert(((Controller_Context_ret_vc >= -100) && (Controller_Context_ret_vc <= 100)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_val_assign_value(dst.val, src.val);
    Controller_Context_ret_assign_value(dst.ret, src.ret);
}
