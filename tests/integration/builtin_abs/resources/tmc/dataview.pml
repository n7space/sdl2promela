...
#define Controller_States_waitforzero 0
#define Controller_States_finished 1
#define Controller_States_waitfornegative 2
#define Controller_States_waitforpositive 3
#define Controller_States_error 4
#define Controller_Context__state_waitforzero 0
#define Controller_Context__state_finished 1
#define Controller_Context__state_waitfornegative 2
#define Controller_Context__state_waitforpositive 3
...
{
    assert((((((Controller_States_vc == Controller_States_waitforzero) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitfornegative)) || (Controller_States_vc == Controller_States_waitforpositive)) || (Controller_States_vc == Controller_States_error)));
}
...
{
    assert((((((Controller_Context__state_vc == Controller_Context__state_waitforzero) || (Controller_Context__state_vc == Controller_Context__state_finished)) || (Controller_Context__state_vc == Controller_Context__state_waitfornegative)) || (Controller_Context__state_vc == Controller_Context__state_waitforpositive)) || (Controller_Context__state_vc == Controller_Context__state_error)));
}
