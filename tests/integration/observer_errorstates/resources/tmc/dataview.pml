...
{
    assert(((Observer_States_vc == Observer_States_wait) || (Observer_States_vc == Observer_States_error)));
}
...
{
    assert(((Observer_Context__state_vc == Observer_Context__state_wait) || (Observer_Context__state_vc == Observer_Context__state_error)));
}
