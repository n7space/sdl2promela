...
#define asn1SccPID_actuatorinst PID_actuatorinst
#define asn1SccPID_controller PID_controller
#define asn1SccPID_env PID_env

#define ERR_PID		76  /*taste-user-interface | timer-manager | actuatorinst | controller | env*/
