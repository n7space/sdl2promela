...
#define Actuator_Context_sender_actuatorinst 0
#define Actuator_Context_sender_controller 1
#define Actuator_Context_sender_env 2
#define Actuator_Context_offspring_actuatorinst 0
...
typedef AggregateTimerData_actuatorinst {
    bit dummy;
}
...
typedef AggregateTimerData {
    AggregateTimerData_actuatorinst actuatorinst;
...
{
    assert((((Actuator_Context_sender_vc == Actuator_Context_sender_actuatorinst) || (Actuator_Context_sender_vc == Actuator_Context_sender_controller)) || (Actuator_Context_sender_vc == Actuator_Context_sender_env)));
}
...
{
    assert((((Actuator_Context_offspring_vc == Actuator_Context_offspring_actuatorinst) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_controller)) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_env)));
}
...
{
    assert((((Controller_Context_sender_vc == Controller_Context_sender_actuatorinst) || (Controller_Context_sender_vc == Controller_Context_sender_controller)) || (Controller_Context_sender_vc == Controller_Context_sender_env)));
}
...
{
    assert((((Controller_Context_offspring_vc == Controller_Context_offspring_actuatorinst) || (Controller_Context_offspring_vc == Controller_Context_offspring_controller)) || (Controller_Context_offspring_vc == Controller_Context_offspring_env)));
}
...
{
    assert((((PID_vc == PID_actuatorinst) || (PID_vc == PID_controller)) || (PID_vc == PID_env)));
}
...
inline AggregateTimerData_actuatorinst_assign_value(dst, src)
{
    skip;
}
...
{
    AggregateTimerData_actuatorinst_assign_value(dst.actuatorinst, src.actuatorinst);
