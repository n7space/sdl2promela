...
#define Actuator_Context__sender_actuatorinst 2
...
#define Actuator_Context__offspring_actuatorinst 2
...
#define Controller_Context__sender_actuatorinst 2
...
#define Controller_Context__offspring_actuatorinst 2
...
typedef AggregateTimerData__actuatorinst {
    bit dummy;
}
...
typedef AggregateTimerData {
    AggregateTimerData__actuatorinst actuatorinst;
...
{
    assert((((((Actuator_Context__offspring_vc == Actuator_Context__offspring_taste_user_interface) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_timer_manager)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_actuatorinst)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_controller)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_env)));
}
...
{
    assert((((((Controller_Context__offspring_vc == Controller_Context__offspring_taste_user_interface) || (Controller_Context__offspring_vc == Controller_Context__offspring_timer_manager)) || (Controller_Context__offspring_vc == Controller_Context__offspring_actuatorinst)) || (Controller_Context__offspring_vc == Controller_Context__offspring_controller)) || (Controller_Context__offspring_vc == Controller_Context__offspring_env)));
}
...
{
    assert((((((PID_vc == PID_taste_user_interface) || (PID_vc == PID_timer_manager)) || (PID_vc == PID_actuatorinst)) || (PID_vc == PID_controller)) || (PID_vc == PID_env)));
}
...
inline AggregateTimerData__actuatorinst_assign_value(dst, src)
{
    skip;
}
...
{
    AggregateTimerData__actuatorinst_assign_value(dst.actuatorinst, src.actuatorinst);
