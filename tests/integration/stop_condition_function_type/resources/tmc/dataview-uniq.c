...
{
    flag ret = TRUE;
    ret = ((((((((((*(pVal)) == PID_taste_user_interface)) || (((*(pVal)) == PID_timer_manager)))) || (((*(pVal)) == PID_actuatorinst)))) || (((*(pVal)) == PID_controller)))) || (((*(pVal)) == PID_env)));
