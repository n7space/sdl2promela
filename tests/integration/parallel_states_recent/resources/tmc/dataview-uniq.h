...
#define asn1SccResultStatus_ok ResultStatus_ok
#define asn1SccResultStatus_work ResultStatus_work

#define ERR_RESULTSTATUS		6  /*ok | work*/
...
#define ERR_UPER_ENCODE_RESULTSTATUS		7  /**/
#define asn1SccResultStatus_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccResultStatus_REQUIRED_BITS_FOR_ENCODING        1

flag asn1SccResultStatus_Encode(const asn1SccResultStatus* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_RESULTSTATUS		8  /**/
