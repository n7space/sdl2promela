...
flag asn1SccResultStatus_IsConstraintValid(const asn1SccResultStatus* pVal, int* pErrCode)
{
    flag ret = TRUE;
    ret = ((((*(pVal)) == ResultStatus_ok)) || (((*(pVal)) == ResultStatus_work)));
    *pErrCode = ret ? 0 :  ERR_RESULTSTATUS;

	return ret;
}

void asn1SccResultStatus_Initialize(asn1SccResultStatus* pVal)
{
	(void)pVal;


	(*(pVal)) = ResultStatus_ok;
}

flag asn1SccResultStatus_Encode(const asn1SccResultStatus* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
    flag ret = TRUE;


	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccResultStatus_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    switch((*(pVal)))
	    {
	        case ResultStatus_ok:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 1);
	        	break;
	        case ResultStatus_work:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 1);
	        	break;
	        default:                    /*COVERAGE_IGNORE*/
	    	    *pErrCode = ERR_UPER_ENCODE_RESULTSTATUS; /*COVERAGE_IGNORE*/
...
flag asn1SccResultStatus_Decode(asn1SccResultStatus* pVal, BitStream* pBitStrm, int* pErrCode)
{
    flag ret = TRUE;
	*pErrCode = 0;
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_RESULTSTATUS;
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	                ...
	                break;
	            case 1:
	                (*(pVal)) = ResultStatus_work;
	                break;
	            default:                        /*COVERAGE_IGNORE*/
		            *pErrCode = ERR_UPER_DECODE_RESULTSTATUS;     /*COVERAGE_IGNORE*/
		            ret = FALSE;                /*COVERAGE_IGNORE*/
	        }
	    } else {
	        (*(pVal)) = ResultStatus_ok;             /*COVERAGE_IGNORE*/
	    }
	}

	return ret  && asn1SccResultStatus_IsConstraintValid(pVal, pErrCode);
}
