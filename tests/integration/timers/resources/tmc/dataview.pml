...
#define AggregateTimerData_actuator_watchdog_timer_enabled bool
#define AggregateTimerData_actuator_watchdog_interval int
...
typedef AggregateTimerData_actuator_watchdog {
    AggregateTimerData_actuator_watchdog_timer_enabled timer_enabled;
    AggregateTimerData_actuator_watchdog_interval interval;
}
...
typedef AggregateTimerData_actuator {
    AggregateTimerData_actuator_watchdog watchdog;
}
...
inline AggregateTimerData_actuator_watchdog_timer_enabled_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData_actuator_watchdog_timer_enabled_range_check(dst);
}
inline AggregateTimerData_actuator_watchdog_timer_enabled_range_check(AggregateTimerData_actuator_watchdog_timer_enabled_vc)
{
    assert(true);
}
inline AggregateTimerData_actuator_watchdog_interval_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData_actuator_watchdog_interval_range_check(dst);
}
inline AggregateTimerData_actuator_watchdog_interval_range_check(AggregateTimerData_actuator_watchdog_interval_vc)
{
    assert(((AggregateTimerData_actuator_watchdog_interval_vc >= 0) && (AggregateTimerData_actuator_watchdog_interval_vc <= 50000)));
}
inline AggregateTimerData_actuator_watchdog_assign_value(dst, src)
{
    AggregateTimerData_actuator_watchdog_timer_enabled_assign_value(dst.timer_enabled, src.timer_enabled);
    AggregateTimerData_actuator_watchdog_interval_assign_value(dst.interval, src.interval);
}
inline AggregateTimerData_actuator_assign_value(dst, src)
{
    AggregateTimerData_actuator_watchdog_assign_value(dst.watchdog, src.watchdog);
}
