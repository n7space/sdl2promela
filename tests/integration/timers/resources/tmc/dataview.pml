...
#define AggregateTimerData__actuator__watchdog__timer_enabled bool
#define AggregateTimerData__actuator__watchdog__interval int
#define Actuator_States_wait 0
#define Actuator_States_operation 1
#define Actuator_Context__state_wait 0
#define Actuator_Context__state_operation 1
...
typedef AggregateTimerData__actuator__watchdog {
    AggregateTimerData__actuator__watchdog__timer_enabled timer_enabled;
    AggregateTimerData__actuator__watchdog__interval interval;
}
...
typedef AggregateTimerData__actuator {
    AggregateTimerData__actuator__watchdog watchdog;
}
...
{
    assert(((Actuator_Context__state_vc == Actuator_Context__state_wait) || (Actuator_Context__state_vc == Actuator_Context__state_operation)));
}
...
inline AggregateTimerData__actuator__watchdog__timer_enabled_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData__actuator__watchdog__timer_enabled_range_check(dst);
}
inline AggregateTimerData__actuator__watchdog__timer_enabled_range_check(AggregateTimerData__actuator__watchdog__timer_enabled_vc)
{
    assert(true);
}
inline AggregateTimerData__actuator__watchdog__interval_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData__actuator__watchdog__interval_range_check(dst);
}
inline AggregateTimerData__actuator__watchdog__interval_range_check(AggregateTimerData__actuator__watchdog__interval_vc)
{
    assert(((AggregateTimerData__actuator__watchdog__interval_vc >= 0) && (AggregateTimerData__actuator__watchdog__interval_vc <= 50000)));
}
inline AggregateTimerData__actuator__watchdog_assign_value(dst, src)
{
    AggregateTimerData__actuator__watchdog__timer_enabled_assign_value(dst.timer_enabled, src.timer_enabled);
    AggregateTimerData__actuator__watchdog__interval_assign_value(dst.interval, src.interval);
}
inline AggregateTimerData__actuator_assign_value(dst, src)
{
    AggregateTimerData__actuator__watchdog_assign_value(dst.watchdog, src.watchdog);
}
