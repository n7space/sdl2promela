...
{
    d_step {
        period_assign_value(demo_timer_manager_periodic_events.data[0].period, 10);
        demo_timer_manager_periodic_events.data[0].event.selection = Demo_Timer_Manager_Event_msg_in_PRESENT;
        demo_timer_manager_periodic_events.data[0].event.data.selection = Demo_Timer_Manager_Event_msg_in_tick_PRESENT;
