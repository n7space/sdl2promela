...
#define Context_actuator__coeff int
...
typedef Context_actuator {
    Context_actuator__coeff coeff;
}
...
Context_actuator actuator_ctxt;
...
{
    assert(((Actuator_Context__result_param_vc >= 0) && (Actuator_Context__result_param_vc <= 100)));
}
...
inline Context_actuator__coeff_assign_value(dst, src)
{
    dst = src;
    Context_actuator__coeff_range_check(dst);
}
inline Context_actuator__coeff_range_check(Context_actuator__coeff_vc)
{
    assert(((Context_actuator__coeff_vc >= 0) && (Context_actuator__coeff_vc <= 100)));
}
inline Context_actuator_assign_value(dst, src)
{
    Context_actuator__coeff_assign_value(dst.coeff, src.coeff);
}
inline actuator_ctxt_init()
{
    d_step {
        MyInteger_assign_value(actuator_ctxt.coeff, 4);
    }
}
...
{
    assert(((Controller_Context__expected_vc >= 0) && (Controller_Context__expected_vc <= 100)));
}
