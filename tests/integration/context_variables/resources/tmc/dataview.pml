...
#define Context_actuator_coeff int
...
{
    assert(((Actuator_Context_result_param_vc >= 0) && (Actuator_Context_result_param_vc <= 100)));
}
...
inline Context_actuator_coeff_assign_value(dst, src)
{
    dst = src;
    Context_actuator_coeff_range_check(dst);
}
inline Context_actuator_coeff_range_check(Context_actuator_coeff_vc)
{
    assert(((Context_actuator_coeff_vc >= 0) && (Context_actuator_coeff_vc <= 100)));
}
inline Context_actuator_assign_value(dst, src)
{
    Context_actuator_coeff_assign_value(dst.coeff, src.coeff);
}
...
{
    assert(((Controller_Context_expected_vc >= 0) && (Controller_Context_expected_vc <= 100)));
}
