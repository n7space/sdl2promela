...
#define Actuator_Context__state_nested_0_red 1
...
#define Controller_States_waitforleavenested 4
#define Controller_States_waitforenternested 5
#define Controller_Context__state_finished 0
#define Controller_Context__state_waitfortransitionnested 1
#define Controller_Context__state_error 2
#define Controller_Context__state_waitfortransitiontop 3
#define Controller_Context__state_waitforleavenested 4
...
{
    assert(((((Actuator_States_vc == Actuator_States_first) || (Actuator_States_vc == Actuator_States_nested_0_red)) || (Actuator_States_vc == Actuator_States_nested_0_green)) || (Actuator_States_vc == Actuator_States_wait)));
}
...
{
    assert(((((Actuator_Context__state_vc == Actuator_Context__state_first) || (Actuator_Context__state_vc == Actuator_Context__state_nested_0_red)) || (Actuator_Context__state_vc == Actuator_Context__state_nested_0_green)) || (Actuator_Context__state_vc == Actuator_Context__state_wait)));
}
...
{
    assert(((((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_waitfortransitionnested)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitfortransitiontop)) || (Controller_States_vc == Controller_States_waitforleavenested)) || (Controller_States_vc == Controller_States_waitforenternested)));
}
