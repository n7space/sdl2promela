...
#define Actuator_Context__nested_0_result_param int
...
#define Actuator_States_nested_0_red 2
#define Actuator_States_wait 3
#define Actuator_Context__state_first 0
#define Actuator_Context__state_nested_0_green 1
#define Actuator_Context__state_nested_0_red 2
...
#define Actuator_Context__result_param_enter_nested 1
#define Actuator_Context__result_param_transition_nested 2
#define Actuator_Context__result_param_leave_nested 3
#define Actuator_Context__nested_0_result_param_transition_top 0
#define Actuator_Context__nested_0_result_param_enter_nested 1
#define Actuator_Context__nested_0_result_param_transition_nested 2
#define Actuator_Context__nested_0_result_param_leave_nested 3
...
#define Controller_States_waitfortransitiontop 0
#define Controller_States_finished 1
#define Controller_States_waitforenternested 2
...
#define Controller_Context__state_waitfortransitiontop 0
#define Controller_Context__state_finished 1
#define Controller_Context__state_waitforenternested 2
#define Controller_Context__state_error 3
#define Controller_Context__state_waitfortransitionnested 4
#define Controller_Context__state_waitforleavenested 5
...
#define Controller_Context__result_param_enter_nested 1
#define Controller_Context__result_param_transition_nested 2
#define Controller_Context__result_param_leave_nested 3
...
typedef Actuator_Context {
    ...
    Actuator_Context__nested_0_result_param nested_0_result_param;
}
...
{
    assert(((((Actuator_States_vc == Actuator_States_first) || (Actuator_States_vc == Actuator_States_nested_0_green)) || (Actuator_States_vc == Actuator_States_nested_0_red)) || (Actuator_States_vc == Actuator_States_wait)));
}
...
{
    assert(((((Actuator_Context__state_vc == Actuator_Context__state_first) || (Actuator_Context__state_vc == Actuator_Context__state_nested_0_green)) || (Actuator_Context__state_vc == Actuator_Context__state_nested_0_red)) || (Actuator_Context__state_vc == Actuator_Context__state_wait)));
}
...
{
    assert(((((Actuator_Context__result_param_vc == Actuator_Context__result_param_transition_top) || (Actuator_Context__result_param_vc == Actuator_Context__result_param_enter_nested)) || (Actuator_Context__result_param_vc == Actuator_Context__result_param_transition_nested)) || (Actuator_Context__result_param_vc == Actuator_Context__result_param_leave_nested)));
}
inline Actuator_Context__nested_0_result_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__nested_0_result_param_range_check(dst);
}
inline Actuator_Context__nested_0_result_param_range_check(Actuator_Context__nested_0_result_param_vc)
{
    assert(((((Actuator_Context__nested_0_result_param_vc == Actuator_Context__nested_0_result_param_transition_top) || (Actuator_Context__nested_0_result_param_vc == Actuator_Context__nested_0_result_param_enter_nested)) || (Actuator_Context__nested_0_result_param_vc == Actuator_Context__nested_0_result_param_transition_nested)) || (Actuator_Context__nested_0_result_param_vc == Actuator_Context__nested_0_result_param_leave_nested)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__nested_0_result_param_assign_value(dst.nested_0_result_param, src.nested_0_result_param);
}
...
{
    assert(((((((Controller_States_vc == Controller_States_waitfortransitiontop) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforenternested)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitfortransitionnested)) || (Controller_States_vc == Controller_States_waitforleavenested)));
}
...
{
    assert(((((((Controller_Context__state_vc == Controller_Context__state_waitfortransitiontop) || (Controller_Context__state_vc == Controller_Context__state_finished)) || (Controller_Context__state_vc == Controller_Context__state_waitforenternested)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitfortransitionnested)) || (Controller_Context__state_vc == Controller_Context__state_waitforleavenested)));
}
...
{
    assert(((((Controller_Context__result_param_vc == Controller_Context__result_param_transition_top) || (Controller_Context__result_param_vc == Controller_Context__result_param_enter_nested)) || (Controller_Context__result_param_vc == Controller_Context__result_param_transition_nested)) || (Controller_Context__result_param_vc == Controller_Context__result_param_leave_nested)));
}
