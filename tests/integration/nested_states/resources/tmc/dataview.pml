...
#define Actuator_Context_state_nested_0_red 2
#define Actuator_Context_state_nested_0_green 3
...
#define Controller_States_waitfortransitionnested 5
...
#define Controller_Context_state_waitfortransitionnested 5
...
{
    assert(((((Actuator_States_vc == Actuator_States_wait) || (Actuator_States_vc == Actuator_States_first)) || (Actuator_States_vc == Actuator_States_nested_0_red)) || (Actuator_States_vc == Actuator_States_nested_0_green)));
}
...
{
    assert(((((Actuator_Context_state_vc == Actuator_Context_state_wait) || (Actuator_Context_state_vc == Actuator_Context_state_first)) || (Actuator_Context_state_vc == Actuator_Context_state_nested_0_red)) || (Actuator_Context_state_vc == Actuator_Context_state_nested_0_green)));
}
...
{
    assert(((((((Controller_States_vc == Controller_States_waitfortransitiontop) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforleavenested)) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforenternested)) || (Controller_States_vc == Controller_States_waitfortransitionnested)));
}
...
{
    assert(((((((Controller_Context_state_vc == Controller_Context_state_waitfortransitiontop) || (Controller_Context_state_vc == Controller_Context_state_error)) || (Controller_Context_state_vc == Controller_Context_state_waitforleavenested)) || (Controller_Context_state_vc == Controller_Context_state_finished)) || (Controller_Context_state_vc == Controller_Context_state_waitforenternested)) || (Controller_Context_state_vc == Controller_Context_state_waitfortransitionnested)));
}
