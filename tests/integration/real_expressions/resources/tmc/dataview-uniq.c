...
{
    flag ret = TRUE;
    ret = ((-1.0000000000000000000E+000 <= (*(pVal))) && ((*(pVal)) <= 1.0000000000000000000E+000));
...
flag asn1SccMyReal_Decode(asn1SccMyReal* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYREAL;

	return ret  && asn1SccMyReal_IsConstraintValid(pVal, pErrCode);
}
...
flag asn1SccMyArray_IsConstraintValid(const asn1SccMyArray* pVal, int* pErrCode)
{
    ...
    {
    	ret = asn1SccMyReal_IsConstraintValid((&(pVal->arr[i1])), pErrCode);
    }
...
flag asn1SccMyArray_Encode(const asn1SccMyArray* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	...
	if (ret && *pErrCode == 0) {
	    ...
	    {
	    	ret = asn1SccMyReal_Encode((&(pVal->arr[i1])), pBitStrm, pErrCode, FALSE);
	    }
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMyArray_Decode(asn1SccMyArray* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	for(i1=0; (i1 < (int)2) && ret; i1++)
	{
		ret = asn1SccMyReal_Decode((&(pVal->arr[i1])), pBitStrm, pErrCode);
	}
...
flag asn1SccMyMatrix_IsConstraintValid(const asn1SccMyMatrix* pVal, int* pErrCode)
{
    ...
    for(i1 = 0; ret && i1 < 2; i1++)
    {
    	ret = asn1SccMyArray_IsConstraintValid((&(pVal->arr[i1])), pErrCode);
    }
...
void asn1SccMyMatrix_Initialize(asn1SccMyMatrix* pVal)
{
	...
	i1 = 0;
	while (i1< 2) {
	    asn1SccMyArray_Initialize((&(pVal->arr[i1])));
	    i1 = i1 + 1;
	}
...
flag asn1SccMyMatrix_Encode(const asn1SccMyMatrix* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	int i1;
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyMatrix_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    for(i1=0; (i1 < (int)2) && ret; i1++)
	    {
	    	ret = asn1SccMyArray_Encode((&(pVal->arr[i1])), pBitStrm, pErrCode, FALSE);
	    }
    } /*COVERAGE_IGNORE*/
...
flag asn1SccMyMatrix_Decode(asn1SccMyMatrix* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	for(i1=0; (i1 < (int)2) && ret; i1++)
	{
		ret = asn1SccMyArray_Decode((&(pVal->arr[i1])), pBitStrm, pErrCode);
	}

	return ret  && asn1SccMyMatrix_IsConstraintValid(pVal, pErrCode);
}
