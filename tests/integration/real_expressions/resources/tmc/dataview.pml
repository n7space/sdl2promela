...
#define Actuator_Context__scalar_p float
#define Actuator_Context__vector_p__elem float
#define Actuator_Context__matrix_p__elem__elem float
#define Actuator_Context__scalar_var float
#define Actuator_Context__vector_var__elem float
#define Actuator_Context__matrix_var__elem__elem float
#define Actuator_Context__r float
...
#define Controller_Context__param_scalar float
#define Controller_Context__param_vector__elem float
#define Controller_Context__param_matrix__elem float
#define Controller_Context__r float
...
#define MyReal float
#define MyArray__elem float
#define MyMatrix__elem__elem float
#define T_Int32 int
#define T_UInt32 int
#define T_Int8 int
#define T_UInt8 int
...
#define Actuator_Context__state_idle 0
...
#define Controller_States_case1 1
#define Controller_States_error 2
#define Controller_States_case3 3
#define Controller_States_case2 4
#define Controller_Context__state_finished 0
#define Controller_Context__state_case1 1
#define Controller_Context__state_error 2
#define Controller_Context__state_case3 3
#define Controller_Context__state_case2 4
...
#define PID_env 4
typedef Actuator_Context__matrix_p__elem {
    Actuator_Context__matrix_p__elem__elem data[2];
}

typedef Actuator_Context__matrix_var__elem {
    Actuator_Context__matrix_var__elem__elem data[2];
}

typedef Actuator_Context__vector_p {
    Actuator_Context__vector_p__elem data[2];
}

typedef Actuator_Context__vector_var {
    Actuator_Context__vector_var__elem data[2];
}
...
typedef Controller_Context__param_matrix {
    Controller_Context__param_matrix__elem data[2];
}

typedef Controller_Context__param_vector {
    Controller_Context__param_vector__elem data[2];
}
...
typedef MyMatrix__elem {
    MyMatrix__elem__elem data[2];
}
...
typedef union T_Runtime_Error_data {
...
typedef Actuator_Context__matrix_p {
    Actuator_Context__matrix_p__elem data[2];
}

typedef Actuator_Context__matrix_var {
    Actuator_Context__matrix_var__elem data[2];
}
...
typedef Controller_Context {
    ...
    Controller_Context__param_scalar param_scalar;
    Controller_Context__param_vector param_vector;
    Controller_Context__param_matrix param_matrix;
    Controller_Context__r r;
}

typedef MyMatrix {
    MyMatrix__elem data[2];
}
...
typedef Actuator_Context {
    ...
    Actuator_Context__scalar_p scalar_p;
    Actuator_Context__vector_p vector_p;
    Actuator_Context__matrix_p matrix_p;
    Actuator_Context__scalar_var scalar_var;
    Actuator_Context__vector_var vector_var;
    Actuator_Context__matrix_var matrix_var;
    Actuator_Context__r r;
}
...
{
    assert((Actuator_States_vc == Actuator_States_idle));
}
...
{
    assert((Actuator_Context__state_vc == Actuator_Context__state_idle));
}
...
inline Actuator_Context__scalar_p_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__scalar_p_range_check(dst);
}
inline Actuator_Context__scalar_p_range_check(Actuator_Context__scalar_p_vc)
{
    assert(((Actuator_Context__scalar_p_vc >= -1) && (Actuator_Context__scalar_p_vc <= 1)));
}
inline Actuator_Context__vector_p__elem_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__vector_p__elem_range_check(dst);
}
inline Actuator_Context__vector_p__elem_range_check(Actuator_Context__vector_p__elem_vc)
{
    assert(((Actuator_Context__vector_p__elem_vc >= -1) && (Actuator_Context__vector_p__elem_vc <= 1)));
}
inline Actuator_Context__vector_p__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__vector_p_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Actuator_Context__vector_p__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Actuator_Context__matrix_p__elem__elem_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__matrix_p__elem__elem_range_check(dst);
}
inline Actuator_Context__matrix_p__elem__elem_range_check(Actuator_Context__matrix_p__elem__elem_vc)
{
    assert(((Actuator_Context__matrix_p__elem__elem_vc >= -1) && (Actuator_Context__matrix_p__elem__elem_vc <= 1)));
}
inline Actuator_Context__matrix_p__elem__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__matrix_p__elem_assign_value(dst, src)
{
    int i_2;
    for(i_2 : 0 .. 1)
    {
        Actuator_Context__matrix_p__elem__elem_assign_value(dst.data[i_2], src.data[i_2]);
    }
}
inline Actuator_Context__matrix_p__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__matrix_p_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Actuator_Context__matrix_p__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Actuator_Context__scalar_var_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__scalar_var_range_check(dst);
}
inline Actuator_Context__scalar_var_range_check(Actuator_Context__scalar_var_vc)
{
    assert(((Actuator_Context__scalar_var_vc >= -1) && (Actuator_Context__scalar_var_vc <= 1)));
}
inline Actuator_Context__vector_var__elem_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__vector_var__elem_range_check(dst);
}
inline Actuator_Context__vector_var__elem_range_check(Actuator_Context__vector_var__elem_vc)
{
    assert(((Actuator_Context__vector_var__elem_vc >= -1) && (Actuator_Context__vector_var__elem_vc <= 1)));
}
inline Actuator_Context__vector_var__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__vector_var_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Actuator_Context__vector_var__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Actuator_Context__matrix_var__elem__elem_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__matrix_var__elem__elem_range_check(dst);
}
inline Actuator_Context__matrix_var__elem__elem_range_check(Actuator_Context__matrix_var__elem__elem_vc)
{
    assert(((Actuator_Context__matrix_var__elem__elem_vc >= -1) && (Actuator_Context__matrix_var__elem__elem_vc <= 1)));
}
inline Actuator_Context__matrix_var__elem__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__matrix_var__elem_assign_value(dst, src)
{
    int i_2;
    for(i_2 : 0 .. 1)
    {
        Actuator_Context__matrix_var__elem__elem_assign_value(dst.data[i_2], src.data[i_2]);
    }
}
inline Actuator_Context__matrix_var__elem_init_value(dst)
{
    skip;
}
inline Actuator_Context__matrix_var_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Actuator_Context__matrix_var__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Actuator_Context__r_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__r_range_check(dst);
}
inline Actuator_Context__r_range_check(Actuator_Context__r_vc)
{
    assert(((Actuator_Context__r_vc >= -1) && (Actuator_Context__r_vc <= 1)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__scalar_p_assign_value(dst.scalar_p, src.scalar_p);
    Actuator_Context__vector_p_assign_value(dst.vector_p, src.vector_p);
    Actuator_Context__matrix_p_assign_value(dst.matrix_p, src.matrix_p);
    Actuator_Context__scalar_var_assign_value(dst.scalar_var, src.scalar_var);
    Actuator_Context__vector_var_assign_value(dst.vector_var, src.vector_var);
    Actuator_Context__matrix_var_assign_value(dst.matrix_var, src.matrix_var);
    Actuator_Context__r_assign_value(dst.r, src.r);
}
...
{
    assert((((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_case1)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_case3)) || (Controller_States_vc == Controller_States_case2)));
}
...
{
    assert((((((Controller_Context__state_vc == Controller_Context__state_finished) || (Controller_Context__state_vc == Controller_Context__state_case1)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_case3)) || (Controller_Context__state_vc == Controller_Context__state_case2)));
}
...
inline Controller_Context__param_scalar_assign_value(dst, src)
{
    dst = src;
    Controller_Context__param_scalar_range_check(dst);
}
inline Controller_Context__param_scalar_range_check(Controller_Context__param_scalar_vc)
{
    assert(((Controller_Context__param_scalar_vc >= -1) && (Controller_Context__param_scalar_vc <= 1)));
}
inline Controller_Context__param_vector__elem_assign_value(dst, src)
{
    dst = src;
    Controller_Context__param_vector__elem_range_check(dst);
}
inline Controller_Context__param_vector__elem_range_check(Controller_Context__param_vector__elem_vc)
{
    assert(((Controller_Context__param_vector__elem_vc >= -1) && (Controller_Context__param_vector__elem_vc <= 1)));
}
inline Controller_Context__param_vector__elem_init_value(dst)
{
    skip;
}
inline Controller_Context__param_vector_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Controller_Context__param_vector__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Controller_Context__param_matrix__elem_assign_value(dst, src)
{
    dst = src;
    Controller_Context__param_matrix__elem_range_check(dst);
}
inline Controller_Context__param_matrix__elem_range_check(Controller_Context__param_matrix__elem_vc)
{
    assert(((Controller_Context__param_matrix__elem_vc >= -1) && (Controller_Context__param_matrix__elem_vc <= 1)));
}
inline Controller_Context__param_matrix__elem_init_value(dst)
{
    skip;
}
inline Controller_Context__param_matrix_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        Controller_Context__param_matrix__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline Controller_Context__r_assign_value(dst, src)
{
    dst = src;
    Controller_Context__r_range_check(dst);
}
inline Controller_Context__r_range_check(Controller_Context__r_vc)
{
    assert(((Controller_Context__r_vc >= -1) && (Controller_Context__r_vc <= 1)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__param_scalar_assign_value(dst.param_scalar, src.param_scalar);
    Controller_Context__param_vector_assign_value(dst.param_vector, src.param_vector);
    Controller_Context__param_matrix_assign_value(dst.param_matrix, src.param_matrix);
    Controller_Context__r_assign_value(dst.r, src.r);
}
...
inline MyReal_assign_value(dst, src)
{
    dst = src;
    MyReal_range_check(dst);
}
inline MyReal_range_check(MyReal_vc)
{
    assert(((MyReal_vc >= -1) && (MyReal_vc <= 1)));
}
...
{
    assert(((MyArray__elem_vc >= -1) && (MyArray__elem_vc <= 1)));
}
...
inline MyMatrix__elem__elem_assign_value(dst, src)
{
    dst = src;
    MyMatrix__elem__elem_range_check(dst);
}
inline MyMatrix__elem__elem_range_check(MyMatrix__elem__elem_vc)
{
    assert(((MyMatrix__elem__elem_vc >= -1) && (MyMatrix__elem__elem_vc <= 1)));
}
inline MyMatrix__elem__elem_init_value(dst)
{
    skip;
}
inline MyMatrix__elem_assign_value(dst, src)
{
    int i_1;
    for(i_1 : 0 .. 1)
    {
        MyMatrix__elem__elem_assign_value(dst.data[i_1], src.data[i_1]);
    }
}
inline MyMatrix__elem_init_value(dst)
{
    skip;
}
inline MyMatrix_assign_value(dst, src)
{
    int i_0;
    for(i_0 : 0 .. 1)
    {
        MyMatrix__elem_assign_value(dst.data[i_0], src.data[i_0]);
    }
}
