...
flag asn1SccMyParameter_IsConstraintValid(const asn1SccMyParameter* pVal, int* pErrCode)
{
    ...
    if (ret) {
        ret = asn1SccMyInteger_IsConstraintValid((&(pVal->y)), pErrCode);
        if (ret) {
            if (pVal->exist.z) {
            	ret = asn1SccMyInteger_IsConstraintValid((&(pVal->z)), pErrCode);
            }
        }   /*COVERAGE_IGNORE*/
    }   /*COVERAGE_IGNORE*/
...
void asn1SccMyParameter_Initialize(asn1SccMyParameter* pVal)
{
	...
	/*set y */
	asn1SccMyInteger_Initialize((&(pVal->y)));
	/*set z */
	pVal->exist.z = 1;
	asn1SccMyInteger_Initialize((&(pVal->z)));
}
...
flag asn1SccMyParameter_Encode(const asn1SccMyParameter* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyParameter_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    BitStream_AppendBit(pBitStrm,pVal->exist.z);
	    if (ret) {
	        /*Encode x */
	        ret = asn1SccMyInteger_Encode((&(pVal->x)), pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode y */
	            ret = asn1SccMyInteger_Encode((&(pVal->y)), pBitStrm, pErrCode, FALSE);
	            if (ret) {
	                /*Encode z */
	                if (pVal->exist.z) {
	                	ret = asn1SccMyInteger_Encode((&(pVal->z)), pBitStrm, pErrCode, FALSE);
	                }
	            }   /*COVERAGE_IGNORE*/
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
...
flag asn1SccMyParameter_Decode(asn1SccMyParameter* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	pVal->exist.z = presenceBit == 0 ? 0 : 1;
	*pErrCode = ret ? 0 : ERR_UPER_DECODE_MYPARAMETER;
	if (ret) {
	    /*Decode x */
	    ret = asn1SccMyInteger_Decode((&(pVal->x)), pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode y */
	        ret = asn1SccMyInteger_Decode((&(pVal->y)), pBitStrm, pErrCode);
	        if (ret) {
	            /*Decode z */
	            if (pVal->exist.z) {
	            	ret = asn1SccMyInteger_Decode((&(pVal->z)), pBitStrm, pErrCode);
	            }
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccMyParameter_IsConstraintValid(pVal, pErrCode);
}
