...
#define Actuator_Context__work_param__x int
#define Actuator_Context__work_param__y int
#define Actuator_Context__work_param__z int
...
#define Controller_Context__work_param__x int
#define Controller_Context__work_param__y int
#define Controller_Context__work_param__z int
...
#define MyParameter__x int
#define MyParameter__y int
#define MyParameter__z int
#define T_Int32 int
#define T_UInt32 int
#define T_Int8 int
#define T_UInt8 int
...
#define PID_env 3
typedef Actuator_Context__work_param_exist {
    bool z;
}
...
typedef Controller_Context__work_param_exist {
    bool z;
}
...
typedef Actuator_Context__work_param {
    Actuator_Context__work_param__x x;
    Actuator_Context__work_param__y y;
    Actuator_Context__work_param__z z;
    Actuator_Context__work_param_exist exist;
}
...
typedef Controller_Context__work_param {
    Controller_Context__work_param__x x;
    Controller_Context__work_param__y y;
    Controller_Context__work_param__z z;
    Controller_Context__work_param_exist exist;
}
...
inline Actuator_Context__work_param__x_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__work_param__x_range_check(dst);
}
inline Actuator_Context__work_param__x_range_check(Actuator_Context__work_param__x_vc)
{
    assert(((Actuator_Context__work_param__x_vc >= 0) && (Actuator_Context__work_param__x_vc <= 10000)));
}
inline Actuator_Context__work_param__y_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__work_param__y_range_check(dst);
}
inline Actuator_Context__work_param__y_range_check(Actuator_Context__work_param__y_vc)
{
    assert(((Actuator_Context__work_param__y_vc >= 0) && (Actuator_Context__work_param__y_vc <= 10000)));
}
inline Actuator_Context__work_param__z_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__work_param__z_range_check(dst);
}
inline Actuator_Context__work_param__z_range_check(Actuator_Context__work_param__z_vc)
{
    assert(((Actuator_Context__work_param__z_vc >= 0) && (Actuator_Context__work_param__z_vc <= 10000)));
}
inline Actuator_Context__work_param_assign_value(dst, src)
{
    Actuator_Context__work_param__x_assign_value(dst.x, src.x);
    Actuator_Context__work_param__y_assign_value(dst.y, src.y);
    Actuator_Context__work_param__z_assign_value(dst.z, src.z);
...
{
    assert(((Controller_Context__test_param_vc >= 0) && (Controller_Context__test_param_vc <= 4)));
}
inline Controller_Context__work_param__x_assign_value(dst, src)
{
    dst = src;
    Controller_Context__work_param__x_range_check(dst);
}
inline Controller_Context__work_param__x_range_check(Controller_Context__work_param__x_vc)
{
    assert(((Controller_Context__work_param__x_vc >= 0) && (Controller_Context__work_param__x_vc <= 10000)));
}
inline Controller_Context__work_param__y_assign_value(dst, src)
{
    dst = src;
    Controller_Context__work_param__y_range_check(dst);
}
inline Controller_Context__work_param__y_range_check(Controller_Context__work_param__y_vc)
{
    assert(((Controller_Context__work_param__y_vc >= 0) && (Controller_Context__work_param__y_vc <= 10000)));
}
inline Controller_Context__work_param__z_assign_value(dst, src)
{
    dst = src;
    Controller_Context__work_param__z_range_check(dst);
}
inline Controller_Context__work_param__z_range_check(Controller_Context__work_param__z_vc)
{
    assert(((Controller_Context__work_param__z_vc >= 0) && (Controller_Context__work_param__z_vc <= 10000)));
}
inline Controller_Context__work_param_assign_value(dst, src)
{
    Controller_Context__work_param__x_assign_value(dst.x, src.x);
    Controller_Context__work_param__y_assign_value(dst.y, src.y);
    Controller_Context__work_param__z_assign_value(dst.z, src.z);
    dst.exist.z = src.exist.z;
}
...
inline MyParameter__x_assign_value(dst, src)
{
    dst = src;
    MyParameter__x_range_check(dst);
}
inline MyParameter__x_range_check(MyParameter__x_vc)
{
    assert(((MyParameter__x_vc >= 0) && (MyParameter__x_vc <= 10000)));
}
inline MyParameter__y_assign_value(dst, src)
{
    dst = src;
    MyParameter__y_range_check(dst);
}
inline MyParameter__y_range_check(MyParameter__y_vc)
{
    assert(((MyParameter__y_vc >= 0) && (MyParameter__y_vc <= 10000)));
}
inline MyParameter__z_assign_value(dst, src)
{
    dst = src;
    MyParameter__z_range_check(dst);
}
inline MyParameter__z_range_check(MyParameter__z_vc)
{
    assert(((MyParameter__z_vc >= 0) && (MyParameter__z_vc <= 10000)));
}
inline MyParameter_assign_value(dst, src)
{
    MyParameter__x_assign_value(dst.x, src.x);
    MyParameter__y_assign_value(dst.y, src.y);
    MyParameter__z_assign_value(dst.z, src.z);
    dst.exist.z = src.exist.z;
}
