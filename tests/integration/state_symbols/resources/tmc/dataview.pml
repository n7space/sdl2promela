...
#define Actuator_Context__work_param int
...
#define Controller_Context__work_param int
...
{
    dst = src;
    Actuator_Context__work_param_range_check(dst);
}
inline Actuator_Context__work_param_range_check(Actuator_Context__work_param_vc)
{
    assert(((Actuator_Context__work_param_vc >= 0) && (Actuator_Context__work_param_vc <= 10000)));
}
...
{
    dst = src;
    Controller_Context__work_param_range_check(dst);
}
inline Controller_Context__work_param_range_check(Controller_Context__work_param_vc)
{
    assert(((Controller_Context__work_param_vc >= 0) && (Controller_Context__work_param_vc <= 10000)));
}
