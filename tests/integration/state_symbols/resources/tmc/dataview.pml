...
#define Actuator_Context_work_param int
...
#define Controller_Context_work_param int
...
#define Controller_States_verifyexcludedstate 2
#define Controller_States_verifysimplestate 3
#define Controller_States_verifydone 4
#define Controller_States_verifystatelist2 5
#define Controller_Context_state_verifystatelist 0
#define Controller_Context_state_verifystar 1
#define Controller_Context_state_verifyexcludedstate 2
#define Controller_Context_state_verifysimplestate 3
#define Controller_Context_state_verifydone 4
#define Controller_Context_state_verifystatelist2 5
...
{
    assert(((Actuator_Context_check_param_vc >= 0) && (Actuator_Context_check_param_vc <= 10000)));
}
inline Actuator_Context_work_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_work_param_range_check(dst);
}
inline Actuator_Context_work_param_range_check(Actuator_Context_work_param_vc)
{
    assert(((Actuator_Context_work_param_vc >= 0) && (Actuator_Context_work_param_vc <= 10000)));
}
...
{
    assert(((((((Controller_Context_state_vc == Controller_Context_state_verifystatelist) || (Controller_Context_state_vc == Controller_Context_state_verifystar)) || (Controller_Context_state_vc == Controller_Context_state_verifyexcludedstate)) || (Controller_Context_state_vc == Controller_Context_state_verifysimplestate)) || (Controller_Context_state_vc == Controller_Context_state_verifydone)) || (Controller_Context_state_vc == Controller_Context_state_verifystatelist2)));
}
...
{
    dst = src;
    Controller_Context_work_param_range_check(dst);
}
inline Controller_Context_work_param_range_check(Controller_Context_work_param_vc)
{
    assert(((Controller_Context_work_param_vc >= 0) && (Controller_Context_work_param_vc <= 10000)));
}
