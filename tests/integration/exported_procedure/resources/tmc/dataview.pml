...
#define Controller_States_waitforboth 3
...
#define Controller_Context_state_waitforboth 3
...
{
    assert(((((((Controller_States_vc == Controller_States_wait) || (Controller_States_vc == Controller_States_waitforproc)) || (Controller_States_vc == Controller_States_success)) || (Controller_States_vc == Controller_States_waitforboth)) || (Controller_States_vc == Controller_States_waitfortrans)) || (Controller_States_vc == Controller_States_failure)));
}
...
{
    assert(((((((Controller_Context_state_vc == Controller_Context_state_wait) || (Controller_Context_state_vc == Controller_Context_state_waitforproc)) || (Controller_Context_state_vc == Controller_Context_state_success)) || (Controller_Context_state_vc == Controller_Context_state_waitforboth)) || (Controller_Context_state_vc == Controller_Context_state_waitfortrans)) || (Controller_Context_state_vc == Controller_Context_state_failure)));
}
