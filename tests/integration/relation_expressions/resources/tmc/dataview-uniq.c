...
{
    flag ret = TRUE;
    ret = ((((((((((((*(pVal)) == RelationTestParam_oper_o_equal)) || (((*(pVal)) == RelationTestParam_oper_o_nequal)))) || (((*(pVal)) == RelationTestParam_oper_o_less)))) || (((*(pVal)) == RelationTestParam_oper_o_lessequal)))) || (((*(pVal)) == RelationTestParam_oper_o_greater)))) || (((*(pVal)) == RelationTestParam_oper_o_greaterequal)));
    *pErrCode = ret ? 0 :  ERR_RELATIONTESTPARAM_OPER;
...
{
    flag ret = TRUE;
    ret = asn1SccRelationTestParam_oper_IsConstraintValid((&(pVal->oper)), pErrCode);
    if (ret) {
        ret = asn1SccMyInteger_IsConstraintValid((&(pVal->left)), pErrCode);
        if (ret) {
            ret = asn1SccMyInteger_IsConstraintValid((&(pVal->right)), pErrCode);
        }   /*COVERAGE_IGNORE*/
    }   /*COVERAGE_IGNORE*/
...
void asn1SccRelationTestParam_oper_Initialize(asn1SccRelationTestParam_oper* pVal)
{
	...
	(*(pVal)) = RelationTestParam_oper_o_equal;
}
void asn1SccRelationTestParam_Initialize(asn1SccRelationTestParam* pVal)
{
	...
	/*set oper */
	asn1SccRelationTestParam_oper_Initialize((&(pVal->oper)));
	/*set left */
	asn1SccMyInteger_Initialize((&(pVal->left)));
	/*set right */
	asn1SccMyInteger_Initialize((&(pVal->right)));
}
...
flag asn1SccRelationTestParam_Encode(const asn1SccRelationTestParam* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccRelationTestParam_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    /*Encode oper */
	    switch(pVal->oper)
	    {
	        case RelationTestParam_oper_o_equal:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 0, 0, 5);
	        	break;
	        case RelationTestParam_oper_o_nequal:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 1, 0, 5);
	        	break;
	        case RelationTestParam_oper_o_less:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 2, 0, 5);
	        	break;
	        case RelationTestParam_oper_o_lessequal:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 3, 0, 5);
	        	break;
	        case RelationTestParam_oper_o_greater:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 4, 0, 5);
	        	break;
	        case RelationTestParam_oper_o_greaterequal:
	            BitStream_EncodeConstraintWholeNumber(pBitStrm, 5, 0, 5);
	        	break;
	        default:                    /*COVERAGE_IGNORE*/
	    	    *pErrCode = ERR_UPER_ENCODE_RELATIONTESTPARAM_OPER; /*COVERAGE_IGNORE*/
	    	    ret = FALSE;            /*COVERAGE_IGNORE*/
	    }
	    if (ret) {
	        /*Encode left */
	        ret = asn1SccMyInteger_Encode((&(pVal->left)), pBitStrm, pErrCode, FALSE);
	        if (ret) {
	            /*Encode right */
	            ret = asn1SccMyInteger_Encode((&(pVal->right)), pBitStrm, pErrCode, FALSE);
	        }   /*COVERAGE_IGNORE*/
	    }   /*COVERAGE_IGNORE*/
    } /*COVERAGE_IGNORE*/
...
flag asn1SccRelationTestParam_Decode(asn1SccRelationTestParam* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
	...
	/*Decode oper */
	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_RELATIONTESTPARAM_OPER;
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	                pVal->oper = RelationTestParam_oper_o_equal;
	                break;
	            case 1:
	                pVal->oper = RelationTestParam_oper_o_nequal;
	                break;
	            case 2:
	                pVal->oper = RelationTestParam_oper_o_less;
	                break;
	            case 3:
	                pVal->oper = RelationTestParam_oper_o_lessequal;
	                break;
	            case 4:
	                pVal->oper = RelationTestParam_oper_o_greater;
	                break;
	            case 5:
	                pVal->oper = RelationTestParam_oper_o_greaterequal;
	                break;
	            default:                        /*COVERAGE_IGNORE*/
		            *pErrCode = ERR_UPER_DECODE_RELATIONTESTPARAM_OPER;     /*COVERAGE_IGNORE*/
		            ret = FALSE;                /*COVERAGE_IGNORE*/
	        }
	    } else {
	        pVal->oper = RelationTestParam_oper_o_equal;             /*COVERAGE_IGNORE*/
	    }
	}
	if (ret) {
	    /*Decode left */
	    ret = asn1SccMyInteger_Decode((&(pVal->left)), pBitStrm, pErrCode);
	    if (ret) {
	        /*Decode right */
	        ret = asn1SccMyInteger_Decode((&(pVal->right)), pBitStrm, pErrCode);
	    }   /*COVERAGE_IGNORE*/
	}   /*COVERAGE_IGNORE*/

	return ret  && asn1SccRelationTestParam_IsConstraintValid(pVal, pErrCode);
}
