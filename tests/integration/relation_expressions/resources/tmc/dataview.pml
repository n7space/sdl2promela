...
#define Actuator_Context__relation__oper int
#define Actuator_Context__relation__left int
#define Actuator_Context__relation__right int
...
#define Controller_Context__relation__oper int
#define Controller_Context__relation__left int
#define Controller_Context__relation__right int
...
#define RelationTestParam__oper int
#define RelationTestParam__left int
#define RelationTestParam__right int
#define T_Int32 int
#define T_UInt32 int
#define T_Int8 int
#define T_UInt8 int
...
#define Actuator_Context__relation__oper_o_equal 0
#define Actuator_Context__relation__oper_o_nequal 1
#define Actuator_Context__relation__oper_o_less 2
#define Actuator_Context__relation__oper_o_lessequal 3
#define Actuator_Context__relation__oper_o_greater 4
#define Actuator_Context__relation__oper_o_greaterequal 5
...
#define Controller_Context__relation__oper_o_equal 0
#define Controller_Context__relation__oper_o_nequal 1
#define Controller_Context__relation__oper_o_less 2
#define Controller_Context__relation__oper_o_lessequal 3
#define Controller_Context__relation__oper_o_greater 4
#define Controller_Context__relation__oper_o_greaterequal 5
...
#define RelationTestParam__oper_o_equal 0
#define RelationTestParam__oper_o_nequal 1
#define RelationTestParam__oper_o_less 2
#define RelationTestParam__oper_o_lessequal 3
#define RelationTestParam__oper_o_greater 4
#define RelationTestParam__oper_o_greaterequal 5
...
#define PID_env 4
typedef Actuator_Context__relation {
    Actuator_Context__relation__oper oper;
    Actuator_Context__relation__left left;
    Actuator_Context__relation__right right;
}
...
typedef Controller_Context__relation {
    Controller_Context__relation__oper oper;
    Controller_Context__relation__left left;
    Controller_Context__relation__right right;
}

typedef RelationTestParam {
    RelationTestParam__oper oper;
    RelationTestParam__left left;
    RelationTestParam__right right;
}
...
typedef Actuator_Context {
    ...
    Actuator_Context__relation relation;
}
...
typedef Controller_Context {
    ...
    Controller_Context__relation relation;
...
inline Actuator_Context__relation__oper_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__relation__oper_range_check(dst);
}
inline Actuator_Context__relation__oper_range_check(Actuator_Context__relation__oper_vc)
{
    assert(((((((Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_equal) || (Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_nequal)) || (Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_less)) || (Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_lessequal)) || (Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_greater)) || (Actuator_Context__relation__oper_vc == Actuator_Context__relation__oper_o_greaterequal)));
}
inline Actuator_Context__relation__left_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__relation__left_range_check(dst);
}
inline Actuator_Context__relation__left_range_check(Actuator_Context__relation__left_vc)
{
    assert(((Actuator_Context__relation__left_vc >= -1024) && (Actuator_Context__relation__left_vc <= 1024)));
}
inline Actuator_Context__relation__right_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__relation__right_range_check(dst);
}
inline Actuator_Context__relation__right_range_check(Actuator_Context__relation__right_vc)
{
    assert(((Actuator_Context__relation__right_vc >= -1024) && (Actuator_Context__relation__right_vc <= 1024)));
}
inline Actuator_Context__relation_assign_value(dst, src)
{
    Actuator_Context__relation__oper_assign_value(dst.oper, src.oper);
    Actuator_Context__relation__left_assign_value(dst.left, src.left);
    Actuator_Context__relation__right_assign_value(dst.right, src.right);
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__relation_assign_value(dst.relation, src.relation);
}
...
inline Controller_Context__relation__oper_assign_value(dst, src)
{
    dst = src;
    Controller_Context__relation__oper_range_check(dst);
}
inline Controller_Context__relation__oper_range_check(Controller_Context__relation__oper_vc)
{
    assert(((((((Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_equal) || (Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_nequal)) || (Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_less)) || (Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_lessequal)) || (Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_greater)) || (Controller_Context__relation__oper_vc == Controller_Context__relation__oper_o_greaterequal)));
}
inline Controller_Context__relation__left_assign_value(dst, src)
{
    dst = src;
    Controller_Context__relation__left_range_check(dst);
}
inline Controller_Context__relation__left_range_check(Controller_Context__relation__left_vc)
{
    assert(((Controller_Context__relation__left_vc >= -1024) && (Controller_Context__relation__left_vc <= 1024)));
}
inline Controller_Context__relation__right_assign_value(dst, src)
{
    dst = src;
    Controller_Context__relation__right_range_check(dst);
}
inline Controller_Context__relation__right_range_check(Controller_Context__relation__right_vc)
{
    assert(((Controller_Context__relation__right_vc >= -1024) && (Controller_Context__relation__right_vc <= 1024)));
}
inline Controller_Context__relation_assign_value(dst, src)
{
    Controller_Context__relation__oper_assign_value(dst.oper, src.oper);
    Controller_Context__relation__left_assign_value(dst.left, src.left);
    Controller_Context__relation__right_assign_value(dst.right, src.right);
}
...
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__relation_assign_value(dst.relation, src.relation);
...
inline RelationTestParam__oper_assign_value(dst, src)
{
    dst = src;
    RelationTestParam__oper_range_check(dst);
}
inline RelationTestParam__oper_range_check(RelationTestParam__oper_vc)
{
    assert(((((((RelationTestParam__oper_vc == RelationTestParam__oper_o_equal) || (RelationTestParam__oper_vc == RelationTestParam__oper_o_nequal)) || (RelationTestParam__oper_vc == RelationTestParam__oper_o_less)) || (RelationTestParam__oper_vc == RelationTestParam__oper_o_lessequal)) || (RelationTestParam__oper_vc == RelationTestParam__oper_o_greater)) || (RelationTestParam__oper_vc == RelationTestParam__oper_o_greaterequal)));
}
inline RelationTestParam__left_assign_value(dst, src)
{
    dst = src;
    RelationTestParam__left_range_check(dst);
}
inline RelationTestParam__left_range_check(RelationTestParam__left_vc)
{
    assert(((RelationTestParam__left_vc >= -1024) && (RelationTestParam__left_vc <= 1024)));
}
inline RelationTestParam__right_assign_value(dst, src)
{
    dst = src;
    RelationTestParam__right_range_check(dst);
}
inline RelationTestParam__right_range_check(RelationTestParam__right_vc)
{
    assert(((RelationTestParam__right_vc >= -1024) && (RelationTestParam__right_vc <= 1024)));
}
inline RelationTestParam_assign_value(dst, src)
{
    RelationTestParam__oper_assign_value(dst.oper, src.oper);
    RelationTestParam__left_assign_value(dst.left, src.left);
    RelationTestParam__right_assign_value(dst.right, src.right);
}
