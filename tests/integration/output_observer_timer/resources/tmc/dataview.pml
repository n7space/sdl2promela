...
#define Observer_Egse_Event_Msg_Out_Selection int
#define Observer_Egse_Event_Selection int
...
#define AggregateTimerData__actuator__trigger__timer_enabled bool
#define AggregateTimerData__actuator__trigger__interval int
#define Observer_States_wait 0
#define Observer_States_reached 1
#define Observer_Context__state_wait 0
#define Observer_Context__state_reached 1
#define Observer_Context__sender_timer_manager 0
#define Observer_Context__sender_actuator 1
#define Observer_Context__sender_controller 2
#define Observer_Context__sender_egse 3
#define Observer_Context__sender_env 4
#define Observer_Context__offspring_timer_manager 0
#define Observer_Context__offspring_actuator 1
#define Observer_Context__offspring_controller 2
#define Observer_Context__offspring_egse 3
...
#define Observer_Egse_Event_Msg_Out_Selection_tick_present 1
#define Observer_Egse_Event_Msg_Out_Selection_test_present 2
#define Observer_Egse_Event_Selection_msg_out_present 1
#define Observer_Function_Event_Selection_actuator_present 1
#define Observer_Function_Event_Selection_controller_present 2
#define Observer_Function_Event_Selection_egse_present 3
...
#define Actuator_Context__sender_timer_manager 0
#define Actuator_Context__sender_actuator 1
#define Actuator_Context__sender_controller 2
#define Actuator_Context__sender_egse 3
#define Actuator_Context__sender_env 4
#define Actuator_Context__offspring_timer_manager 0
#define Actuator_Context__offspring_actuator 1
#define Actuator_Context__offspring_controller 2
#define Actuator_Context__offspring_egse 3
...
#define Controller_Context__sender_timer_manager 0
#define Controller_Context__sender_actuator 1
#define Controller_Context__sender_controller 2
#define Controller_Context__sender_egse 3
#define Controller_Context__sender_env 4
#define Controller_Context__offspring_timer_manager 0
#define Controller_Context__offspring_actuator 1
#define Controller_Context__offspring_controller 2
#define Controller_Context__offspring_egse 3
...
typedef AggregateTimerData__actuator__trigger {
    AggregateTimerData__actuator__trigger__timer_enabled timer_enabled;
    AggregateTimerData__actuator__trigger__interval interval;
}
...
typedef AggregateTimerData__actuator {
    AggregateTimerData__actuator__trigger trigger;
}
...
{
    assert(((Observer_Context__state_vc == Observer_Context__state_wait) || (Observer_Context__state_vc == Observer_Context__state_reached)));
}
...
{
    assert((((((Observer_Context__sender_vc == Observer_Context__sender_timer_manager) || (Observer_Context__sender_vc == Observer_Context__sender_actuator)) || (Observer_Context__sender_vc == Observer_Context__sender_controller)) || (Observer_Context__sender_vc == Observer_Context__sender_egse)) || (Observer_Context__sender_vc == Observer_Context__sender_env)));
}
...
inline Observer_Egse_Event_Msg_Out_Selection_assign_value(dst, src)
{
    dst = src;
    Observer_Egse_Event_Msg_Out_Selection_range_check(dst);
}
inline Observer_Egse_Event_Msg_Out_Selection_range_check(Observer_Egse_Event_Msg_Out_Selection_vc)
{
    assert(((Observer_Egse_Event_Msg_Out_Selection_vc == Observer_Egse_Event_Msg_Out_Selection_tick_present) || (Observer_Egse_Event_Msg_Out_Selection_vc == Observer_Egse_Event_Msg_Out_Selection_test_present)));
}
inline Observer_Egse_Event_Selection_assign_value(dst, src)
{
    dst = src;
    Observer_Egse_Event_Selection_range_check(dst);
}
inline Observer_Egse_Event_Selection_range_check(Observer_Egse_Event_Selection_vc)
{
    assert((Observer_Egse_Event_Selection_vc == Observer_Egse_Event_Selection_msg_out_present));
}
...
{
    assert((((((Actuator_Context__sender_vc == Actuator_Context__sender_timer_manager) || (Actuator_Context__sender_vc == Actuator_Context__sender_actuator)) || (Actuator_Context__sender_vc == Actuator_Context__sender_controller)) || (Actuator_Context__sender_vc == Actuator_Context__sender_egse)) || (Actuator_Context__sender_vc == Actuator_Context__sender_env)));
}
...
{
    assert((((((Actuator_Context__offspring_vc == Actuator_Context__offspring_timer_manager) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_actuator)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_controller)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_egse)) || (Actuator_Context__offspring_vc == Actuator_Context__offspring_env)));
}
...
{
    assert((((((Controller_Context__sender_vc == Controller_Context__sender_timer_manager) || (Controller_Context__sender_vc == Controller_Context__sender_actuator)) || (Controller_Context__sender_vc == Controller_Context__sender_controller)) || (Controller_Context__sender_vc == Controller_Context__sender_egse)) || (Controller_Context__sender_vc == Controller_Context__sender_env)));
}
...
{
    assert((((((Controller_Context__offspring_vc == Controller_Context__offspring_timer_manager) || (Controller_Context__offspring_vc == Controller_Context__offspring_actuator)) || (Controller_Context__offspring_vc == Controller_Context__offspring_controller)) || (Controller_Context__offspring_vc == Controller_Context__offspring_egse)) || (Controller_Context__offspring_vc == Controller_Context__offspring_env)));
}
...
{
    assert((((((PID_vc == PID_timer_manager) || (PID_vc == PID_actuator)) || (PID_vc == PID_controller)) || (PID_vc == PID_egse)) || (PID_vc == PID_env)));
}
...
inline AggregateTimerData__actuator__trigger__timer_enabled_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData__actuator__trigger__timer_enabled_range_check(dst);
}
inline AggregateTimerData__actuator__trigger__timer_enabled_range_check(AggregateTimerData__actuator__trigger__timer_enabled_vc)
{
    assert(true);
}
inline AggregateTimerData__actuator__trigger__interval_assign_value(dst, src)
{
    dst = src;
    AggregateTimerData__actuator__trigger__interval_range_check(dst);
}
inline AggregateTimerData__actuator__trigger__interval_range_check(AggregateTimerData__actuator__trigger__interval_vc)
{
    assert(((AggregateTimerData__actuator__trigger__interval_vc >= 0) && (AggregateTimerData__actuator__trigger__interval_vc <= 50000)));
}
inline AggregateTimerData__actuator__trigger_assign_value(dst, src)
{
    AggregateTimerData__actuator__trigger__timer_enabled_assign_value(dst.timer_enabled, src.timer_enabled);
    AggregateTimerData__actuator__trigger__interval_assign_value(dst.interval, src.interval);
}
inline AggregateTimerData__actuator_assign_value(dst, src)
{
    AggregateTimerData__actuator__trigger_assign_value(dst.trigger, src.trigger);
}
