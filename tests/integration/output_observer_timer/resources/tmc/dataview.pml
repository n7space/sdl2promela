...
#define Observer_Context_sender_egse 3
#define Observer_Context_sender_env 4
...
#define Observer_Context_offspring_egse 3
#define Observer_Context_offspring_env 4
...
#define Actuator_Context_offspring_egse 3
...
#define Controller_Context_sender_egse 3
...
#define Controller_Context_offspring_egse 3
...
{
    assert((((((Observer_Context_sender_vc == Observer_Context_sender_timer_manager) || (Observer_Context_sender_vc == Observer_Context_sender_actuator)) || (Observer_Context_sender_vc == Observer_Context_sender_controller)) || (Observer_Context_sender_vc == Observer_Context_sender_egse)) || (Observer_Context_sender_vc == Observer_Context_sender_env)));
}
...
{
    assert((((((Observer_Context_offspring_vc == Observer_Context_offspring_timer_manager) || (Observer_Context_offspring_vc == Observer_Context_offspring_actuator)) || (Observer_Context_offspring_vc == Observer_Context_offspring_controller)) || (Observer_Context_offspring_vc == Observer_Context_offspring_egse)) || (Observer_Context_offspring_vc == Observer_Context_offspring_env)));
}
...
{
    assert((((((Actuator_Context_sender_vc == Actuator_Context_sender_timer_manager) || (Actuator_Context_sender_vc == Actuator_Context_sender_actuator)) || (Actuator_Context_sender_vc == Actuator_Context_sender_controller)) || (Actuator_Context_sender_vc == Actuator_Context_sender_egse)) || (Actuator_Context_sender_vc == Actuator_Context_sender_env)));
}
...
{
    assert((((((Actuator_Context_offspring_vc == Actuator_Context_offspring_timer_manager) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_actuator)) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_controller)) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_egse)) || (Actuator_Context_offspring_vc == Actuator_Context_offspring_env)));
}
...
{
    assert((((((Controller_Context_sender_vc == Controller_Context_sender_timer_manager) || (Controller_Context_sender_vc == Controller_Context_sender_actuator)) || (Controller_Context_sender_vc == Controller_Context_sender_controller)) || (Controller_Context_sender_vc == Controller_Context_sender_egse)) || (Controller_Context_sender_vc == Controller_Context_sender_env)));
}
...
{
    assert((((((Controller_Context_offspring_vc == Controller_Context_offspring_timer_manager) || (Controller_Context_offspring_vc == Controller_Context_offspring_actuator)) || (Controller_Context_offspring_vc == Controller_Context_offspring_controller)) || (Controller_Context_offspring_vc == Controller_Context_offspring_egse)) || (Controller_Context_offspring_vc == Controller_Context_offspring_env)));
}
