...
#define Controller_Context__state_secondcheck 2
...
{
    assert(((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_firstcheck)) || (Controller_States_vc == Controller_States_secondcheck)) || (Controller_States_vc == Controller_States_error)));
}
...
{
    assert(((((Controller_Context__state_vc == Controller_Context__state_finished) || (Controller_Context__state_vc == Controller_Context__state_firstcheck)) || (Controller_Context__state_vc == Controller_Context__state_secondcheck)) || (Controller_Context__state_vc == Controller_Context__state_error)));
}
