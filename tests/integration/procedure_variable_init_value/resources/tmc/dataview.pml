...
#define Actuator_Context__input_val int
#define Actuator_Context__output_val int
...
#define Controller_Context__result int
...
#define Controller_States_firstcheck 1
#define Controller_States_error 2
#define Controller_States_secondcheck 3
#define Controller_Context__state_finished 0
#define Controller_Context__state_firstcheck 1
#define Controller_Context__state_error 2
#define Controller_Context__state_secondcheck 3
...
typedef Actuator_Context {
    ...
    Actuator_Context__input_val input_val;
    Actuator_Context__output_val output_val;
}
...
typedef Controller_Context {
    ...
    Controller_Context__result result;
}
...
inline Actuator_Context__input_val_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__input_val_range_check(dst);
}
inline Actuator_Context__input_val_range_check(Actuator_Context__input_val_vc)
{
    assert(((Actuator_Context__input_val_vc >= 0) && (Actuator_Context__input_val_vc <= 10000)));
}
inline Actuator_Context__output_val_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__output_val_range_check(dst);
}
inline Actuator_Context__output_val_range_check(Actuator_Context__output_val_vc)
{
    assert(((Actuator_Context__output_val_vc >= 0) && (Actuator_Context__output_val_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__input_val_assign_value(dst.input_val, src.input_val);
    Actuator_Context__output_val_assign_value(dst.output_val, src.output_val);
}
...
{
    assert(((((Controller_States_vc == Controller_States_finished) || (Controller_States_vc == Controller_States_firstcheck)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_secondcheck)));
}
...
{
    assert(((((Controller_Context__state_vc == Controller_Context__state_finished) || (Controller_Context__state_vc == Controller_Context__state_firstcheck)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_secondcheck)));
}
...
inline Controller_Context__result_assign_value(dst, src)
{
    dst = src;
    Controller_Context__result_range_check(dst);
}
inline Controller_Context__result_range_check(Controller_Context__result_vc)
{
    assert(((Controller_Context__result_vc >= 0) && (Controller_Context__result_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__result_assign_value(dst.result, src.result);
}
