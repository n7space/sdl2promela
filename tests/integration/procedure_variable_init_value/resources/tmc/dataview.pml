...
#define Actuator_Context_input_val int
#define Actuator_Context_output_val int
...
#define Controller_Context_result int
...
#define Controller_Context_state_firstcheck 1
...
typedef Actuator_Context {
    ...
    Actuator_Context_input_val input_val;
    Actuator_Context_output_val output_val;
}
...
typedef Controller_Context {
    ...
    Controller_Context_result result;
}
...
inline Actuator_Context_input_val_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_input_val_range_check(dst);
}
inline Actuator_Context_input_val_range_check(Actuator_Context_input_val_vc)
{
    assert(((Actuator_Context_input_val_vc >= 0) && (Actuator_Context_input_val_vc <= 10000)));
}
inline Actuator_Context_output_val_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_output_val_range_check(dst);
}
inline Actuator_Context_output_val_range_check(Actuator_Context_output_val_vc)
{
    assert(((Actuator_Context_output_val_vc >= 0) && (Actuator_Context_output_val_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context_input_val_assign_value(dst.input_val, src.input_val);
    Actuator_Context_output_val_assign_value(dst.output_val, src.output_val);
}
...
{
    assert(((((Controller_States_vc == Controller_States_secondcheck) || (Controller_States_vc == Controller_States_firstcheck)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_finished)));
}
...
{
    assert(((((Controller_Context_state_vc == Controller_Context_state_secondcheck) || (Controller_Context_state_vc == Controller_Context_state_firstcheck)) || (Controller_Context_state_vc == Controller_Context_state_error)) || (Controller_Context_state_vc == Controller_Context_state_finished)));
}
...
inline Controller_Context_result_assign_value(dst, src)
{
    dst = src;
    Controller_Context_result_range_check(dst);
}
inline Controller_Context_result_range_check(Controller_Context_result_vc)
{
    assert(((Controller_Context_result_vc >= 0) && (Controller_Context_result_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_result_assign_value(dst.result, src.result);
}
