...
#define Controller_States_testunprotected 0
#define Controller_States_finished 1
#define Controller_States_error 2
#define Controller_States_waitforresponse 3
#define Controller_States_testprotected 4
#define Controller_Context__state_testunprotected 0
#define Controller_Context__state_finished 1
#define Controller_Context__state_error 2
#define Controller_Context__state_waitforresponse 3
#define Controller_Context__state_testprotected 4
...
{
    assert((((((Controller_States_vc == Controller_States_testunprotected) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforresponse)) || (Controller_States_vc == Controller_States_testprotected)));
}
...
{
    assert((((((Controller_Context__state_vc == Controller_Context__state_testunprotected) || (Controller_Context__state_vc == Controller_Context__state_finished)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitforresponse)) || (Controller_Context__state_vc == Controller_Context__state_testprotected)));
}
