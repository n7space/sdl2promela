...
#define Controller_Context_lhs_param int
#define Controller_Context_rhs_param int
#define Controller_Context_actuator_result int
...
#define Controller_States_testprotected 2
#define Controller_States_finished 3
#define Controller_States_waitforresponse 4
#define Controller_Context_state_error 0
#define Controller_Context_state_testunprotected 1
#define Controller_Context_state_testprotected 2
#define Controller_Context_state_finished 3
#define Controller_Context_state_waitforresponse 4
...
typedef Controller_Context {
    ...
    Controller_Context_lhs_param lhs_param;
    Controller_Context_rhs_param rhs_param;
    Controller_Context_actuator_result actuator_result;
}
...
{
    assert((((((Controller_States_vc == Controller_States_error) || (Controller_States_vc == Controller_States_testunprotected)) || (Controller_States_vc == Controller_States_testprotected)) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforresponse)));
}
...
inline Controller_Context_lhs_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context_lhs_param_range_check(dst);
}
inline Controller_Context_lhs_param_range_check(Controller_Context_lhs_param_vc)
{
    assert(((Controller_Context_lhs_param_vc >= 0) && (Controller_Context_lhs_param_vc <= 10000)));
}
inline Controller_Context_rhs_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context_rhs_param_range_check(dst);
}
inline Controller_Context_rhs_param_range_check(Controller_Context_rhs_param_vc)
{
    assert(((Controller_Context_rhs_param_vc >= 0) && (Controller_Context_rhs_param_vc <= 10000)));
}
inline Controller_Context_actuator_result_assign_value(dst, src)
{
    dst = src;
    Controller_Context_actuator_result_range_check(dst);
}
inline Controller_Context_actuator_result_range_check(Controller_Context_actuator_result_vc)
{
    assert(((Controller_Context_actuator_result_vc >= 0) && (Controller_Context_actuator_result_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_lhs_param_assign_value(dst.lhs_param, src.lhs_param);
    Controller_Context_rhs_param_assign_value(dst.rhs_param, src.rhs_param);
    Controller_Context_actuator_result_assign_value(dst.actuator_result, src.actuator_result);
}
