...
#define Controller_Context__lhs_param int
#define Controller_Context__rhs_param int
#define Controller_Context__actuator_result int
...
#define Controller_States_testunprotected 1
#define Controller_States_finished 2
#define Controller_States_error 3
#define Controller_States_waitforresponse 4
#define Controller_Context__state_testprotected 0
#define Controller_Context__state_testunprotected 1
#define Controller_Context__state_finished 2
#define Controller_Context__state_error 3
#define Controller_Context__state_waitforresponse 4
...
typedef Controller_Context {
    ...
    Controller_Context__lhs_param lhs_param;
    Controller_Context__rhs_param rhs_param;
    Controller_Context__actuator_result actuator_result;
}
...
{
    assert((((((Controller_States_vc == Controller_States_testprotected) || (Controller_States_vc == Controller_States_testunprotected)) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_error)) || (Controller_States_vc == Controller_States_waitforresponse)));
}
...
{
    assert((((((Controller_Context__state_vc == Controller_Context__state_testprotected) || (Controller_Context__state_vc == Controller_Context__state_testunprotected)) || (Controller_Context__state_vc == Controller_Context__state_finished)) || (Controller_Context__state_vc == Controller_Context__state_error)) || (Controller_Context__state_vc == Controller_Context__state_waitforresponse)));
}
...
inline Controller_Context__lhs_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context__lhs_param_range_check(dst);
}
inline Controller_Context__lhs_param_range_check(Controller_Context__lhs_param_vc)
{
    assert(((Controller_Context__lhs_param_vc >= 0) && (Controller_Context__lhs_param_vc <= 10000)));
}
inline Controller_Context__rhs_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context__rhs_param_range_check(dst);
}
inline Controller_Context__rhs_param_range_check(Controller_Context__rhs_param_vc)
{
    assert(((Controller_Context__rhs_param_vc >= 0) && (Controller_Context__rhs_param_vc <= 10000)));
}
inline Controller_Context__actuator_result_assign_value(dst, src)
{
    dst = src;
    Controller_Context__actuator_result_range_check(dst);
}
inline Controller_Context__actuator_result_range_check(Controller_Context__actuator_result_vc)
{
    assert(((Controller_Context__actuator_result_vc >= 0) && (Controller_Context__actuator_result_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__lhs_param_assign_value(dst.lhs_param, src.lhs_param);
    Controller_Context__rhs_param_assign_value(dst.rhs_param, src.rhs_param);
    Controller_Context__actuator_result_assign_value(dst.actuator_result, src.actuator_result);
}
