...
#define System_State_controller_lhs_param int
#define System_State_controller_rhs_param int
#define System_State_controller_actuator_result int
...
#define Controller_States_testprotected 1
...
#define Controller_Context_state_testprotected 1
...
#define System_State_controller_state_testprotected 1
#define System_State_controller_state_finished 2
#define System_State_controller_state_waitforresponse 3
#define System_State_controller_state_testunprotected 4
...
typedef System_State_controller {
    ...
    System_State_controller_lhs_param lhs_param;
    System_State_controller_rhs_param rhs_param;
    System_State_controller_actuator_result actuator_result;
}
...
{
    assert((((((Controller_States_vc == Controller_States_error) || (Controller_States_vc == Controller_States_testprotected)) || (Controller_States_vc == Controller_States_finished)) || (Controller_States_vc == Controller_States_waitforresponse)) || (Controller_States_vc == Controller_States_testunprotected)));
}
...
{
    assert((((((System_State_controller_state_vc == System_State_controller_state_error) || (System_State_controller_state_vc == System_State_controller_state_testprotected)) || (System_State_controller_state_vc == System_State_controller_state_finished)) || (System_State_controller_state_vc == System_State_controller_state_waitforresponse)) || (System_State_controller_state_vc == System_State_controller_state_testunprotected)));
}
...
inline System_State_controller_lhs_param_assign_value(dst, src)
{
    dst = src;
    System_State_controller_lhs_param_range_check(dst);
}
inline System_State_controller_lhs_param_range_check(System_State_controller_lhs_param_vc)
{
    assert(((System_State_controller_lhs_param_vc >= 0) && (System_State_controller_lhs_param_vc <= 10000)));
}
inline System_State_controller_rhs_param_assign_value(dst, src)
{
    dst = src;
    System_State_controller_rhs_param_range_check(dst);
}
inline System_State_controller_rhs_param_range_check(System_State_controller_rhs_param_vc)
{
    assert(((System_State_controller_rhs_param_vc >= 0) && (System_State_controller_rhs_param_vc <= 10000)));
}
inline System_State_controller_actuator_result_assign_value(dst, src)
{
    dst = src;
    System_State_controller_actuator_result_range_check(dst);
}
inline System_State_controller_actuator_result_range_check(System_State_controller_actuator_result_vc)
{
    assert(((System_State_controller_actuator_result_vc >= 0) && (System_State_controller_actuator_result_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_lhs_param_assign_value(dst.lhs_param, src.lhs_param);
    System_State_controller_rhs_param_assign_value(dst.rhs_param, src.rhs_param);
    System_State_controller_actuator_result_assign_value(dst.actuator_result, src.actuator_result);
}
