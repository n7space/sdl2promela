...
#define Controller_Context_count int
...
typedef Controller_Context {
    ...
    Controller_Context_count count;
...
{
    assert(((Controller_Context_param_vc >= 0) && (Controller_Context_param_vc <= 1)));
}
inline Controller_Context_count_assign_value(dst, src)
{
    dst = src;
    Controller_Context_count_range_check(dst);
}
inline Controller_Context_count_range_check(Controller_Context_count_vc)
{
    assert(((Controller_Context_count_vc >= 0) && (Controller_Context_count_vc <= 10000)));
}
...
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_count_assign_value(dst.count, src.count);
