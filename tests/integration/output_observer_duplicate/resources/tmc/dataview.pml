...
#define Controller_Context__count int
...
typedef Controller_Context {
    ...
    Controller_Context__count count;
...
{
    assert(((Controller_Context__param_vc >= 0) && (Controller_Context__param_vc <= 1)));
}
inline Controller_Context__count_assign_value(dst, src)
{
    dst = src;
    Controller_Context__count_range_check(dst);
}
inline Controller_Context__count_range_check(Controller_Context__count_vc)
{
    assert(((Controller_Context__count_vc >= 0) && (Controller_Context__count_vc <= 10000)));
}
...
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__count_assign_value(dst.count, src.count);
...
{
    assert(((MyTestInteger_vc >= 0) && (MyTestInteger_vc <= 1)));
}
...
{
    assert(((Environ_test_p1_vc >= 0) && (Environ_test_p1_vc <= 1)));
}
