...
#define Actuator_Context__state_special 0
#define Actuator_Context__state_wait 1
#define Actuator_Context__state_error 2
...
#define Controller_Context__state_testing 1
...
{
    assert((((Actuator_States_vc == Actuator_States_special) || (Actuator_States_vc == Actuator_States_wait)) || (Actuator_States_vc == Actuator_States_error)));
}
...
{
    assert((((Actuator_Context__state_vc == Actuator_Context__state_special) || (Actuator_Context__state_vc == Actuator_Context__state_wait)) || (Actuator_Context__state_vc == Actuator_Context__state_error)));
}
...
{
    assert(((Controller_States_vc == Controller_States_wait) || (Controller_States_vc == Controller_States_testing)));
}
...
{
    assert(((Controller_Context__state_vc == Controller_Context__state_wait) || (Controller_Context__state_vc == Controller_Context__state_testing)));
}
