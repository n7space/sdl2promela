...
#define Actuator_States_error 0
#define Actuator_States_special 1
#define Actuator_States_wait 2
#define Actuator_Context__state_error 0
#define Actuator_Context__state_special 1
...
#define Controller_Context__state_testing 0
...
{
    assert((((Actuator_States_vc == Actuator_States_error) || (Actuator_States_vc == Actuator_States_special)) || (Actuator_States_vc == Actuator_States_wait)));
}
...
{
    assert((((Actuator_Context__state_vc == Actuator_Context__state_error) || (Actuator_Context__state_vc == Actuator_Context__state_special)) || (Actuator_Context__state_vc == Actuator_Context__state_wait)));
}
...
{
    assert(((Controller_States_vc == Controller_States_testing) || (Controller_States_vc == Controller_States_wait)));
}
...
{
    assert(((Controller_Context__state_vc == Controller_Context__state_testing) || (Controller_Context__state_vc == Controller_Context__state_wait)));
}
...
{
    assert(((Controller_Context__test_param_vc >= 0) && (Controller_Context__test_param_vc <= 5)));
}
...
{
    assert(((MyTestInteger_vc >= 0) && (MyTestInteger_vc <= 5)));
}
...
{
    assert(((Environ_test_p1_vc >= 0) && (Environ_test_p1_vc <= 5)));
}
