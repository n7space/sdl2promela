...
#define Actuator_States_special 2
#define Actuator_Context_state_error 0
#define Actuator_Context_state_wait 1
#define Actuator_Context_state_special 2
...
#define Controller_Context_state_testing 1
...
{
    assert((((Actuator_States_vc == Actuator_States_error) || (Actuator_States_vc == Actuator_States_wait)) || (Actuator_States_vc == Actuator_States_special)));
}
...
{
    assert((((Actuator_Context_state_vc == Actuator_Context_state_error) || (Actuator_Context_state_vc == Actuator_Context_state_wait)) || (Actuator_Context_state_vc == Actuator_Context_state_special)));
}
...
{
    assert(((Controller_Context_state_vc == Controller_Context_state_wait) || (Controller_Context_state_vc == Controller_Context_state_testing)));
}
...
{
    assert(((Controller_Context_test_param_vc >= 0) && (Controller_Context_test_param_vc <= 5)));
}
