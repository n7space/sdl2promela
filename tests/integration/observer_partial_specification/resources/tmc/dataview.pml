...
#define Controller_Context__ok int
...
inline Controller_Context__ok_assign_value(dst, src)
{
    dst = src;
    Controller_Context__ok_range_check(dst);
}
inline Controller_Context__ok_range_check(Controller_Context__ok_vc)
{
    assert(((Controller_Context__ok_vc >= 0) && (Controller_Context__ok_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__ok_assign_value(dst.ok, src.ok);
}
