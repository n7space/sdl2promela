...
#define Controller_Context_ok int
...
inline Controller_Context_ok_assign_value(dst, src)
{
    dst = src;
    Controller_Context_ok_range_check(dst);
}
inline Controller_Context_ok_range_check(Controller_Context_ok_vc)
{
    assert(((Controller_Context_ok_vc >= 0) && (Controller_Context_ok_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context_ok_assign_value(dst.ok, src.ok);
}
