...
#define System_State_controller_ok int
...
inline System_State_controller_ok_assign_value(dst, src)
{
    dst = src;
    System_State_controller_ok_range_check(dst);
}
inline System_State_controller_ok_range_check(System_State_controller_ok_vc)
{
    assert(((System_State_controller_ok_vc >= 0) && (System_State_controller_ok_vc <= 10000)));
}
inline System_State_controller_assign_value(dst, src)
{
    ...
    System_State_controller_ok_assign_value(dst.ok, src.ok);
}
