...
#define Actuator_Context__operation_0_ping_param int
#define Actuator_Context__operation_0_pong_param int
...
#define Observer_Actuator_Event_Msg_In_Selection_reset_present 3
...
#define Observer_Controller_Event_Msg_Out_Selection_reset_present 2
...
#define Actuator_States_operation_0_repeat 0
#define Actuator_States_operation_0_add 1
#define Actuator_States_disabled 2
#define Actuator_Context__state_operation_0_repeat 0
#define Actuator_Context__state_operation_0_add 1
#define Actuator_Context__state_disabled 2
...
typedef Actuator_Context {
    ...
    Actuator_Context__operation_0_ping_param operation_0_ping_param;
    Actuator_Context__operation_0_pong_param operation_0_pong_param;
}
...
{
    assert((((Observer_Actuator_Event_Msg_In_Selection_vc == Observer_Actuator_Event_Msg_In_Selection_input_none_present) || (Observer_Actuator_Event_Msg_In_Selection_vc == Observer_Actuator_Event_Msg_In_Selection_ping_present)) || (Observer_Actuator_Event_Msg_In_Selection_vc == Observer_Actuator_Event_Msg_In_Selection_reset_present)));
}
...
{
    assert(((Observer_Controller_Event_Msg_Out_Selection_vc == Observer_Controller_Event_Msg_Out_Selection_ping_present) || (Observer_Controller_Event_Msg_Out_Selection_vc == Observer_Controller_Event_Msg_Out_Selection_reset_present)));
}
...
{
    assert((((Actuator_States_vc == Actuator_States_operation_0_repeat) || (Actuator_States_vc == Actuator_States_operation_0_add)) || (Actuator_States_vc == Actuator_States_disabled)));
}
...
{
    assert((((Actuator_Context__state_vc == Actuator_Context__state_operation_0_repeat) || (Actuator_Context__state_vc == Actuator_Context__state_operation_0_add)) || (Actuator_Context__state_vc == Actuator_Context__state_disabled)));
}
...
inline Actuator_Context__operation_0_ping_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__operation_0_ping_param_range_check(dst);
}
inline Actuator_Context__operation_0_ping_param_range_check(Actuator_Context__operation_0_ping_param_vc)
{
    assert(((Actuator_Context__operation_0_ping_param_vc >= 0) && (Actuator_Context__operation_0_ping_param_vc <= 10000)));
}
inline Actuator_Context__operation_0_pong_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__operation_0_pong_param_range_check(dst);
}
inline Actuator_Context__operation_0_pong_param_range_check(Actuator_Context__operation_0_pong_param_vc)
{
    assert(((Actuator_Context__operation_0_pong_param_vc >= 0) && (Actuator_Context__operation_0_pong_param_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__operation_0_ping_param_assign_value(dst.operation_0_ping_param, src.operation_0_ping_param);
    Actuator_Context__operation_0_pong_param_assign_value(dst.operation_0_pong_param, src.operation_0_pong_param);
}
