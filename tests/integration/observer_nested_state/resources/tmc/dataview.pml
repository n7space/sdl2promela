...
#define Actuator_Context_operation_0_ping_param int
#define Actuator_Context_operation_0_pong_param int
...
#define Actuator_Context_state_disabled 2
...
typedef Actuator_Context {
    ...
    Actuator_Context_operation_0_ping_param operation_0_ping_param;
    Actuator_Context_operation_0_pong_param operation_0_pong_param;
}
...
{
    assert((((Actuator_States_vc == Actuator_States_operation_0_add) || (Actuator_States_vc == Actuator_States_operation_0_repeat)) || (Actuator_States_vc == Actuator_States_disabled)));
}
...
{
    assert((((Actuator_Context_state_vc == Actuator_Context_state_operation_0_add) || (Actuator_Context_state_vc == Actuator_Context_state_operation_0_repeat)) || (Actuator_Context_state_vc == Actuator_Context_state_disabled)));
}
...
inline Actuator_Context_operation_0_ping_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_operation_0_ping_param_range_check(dst);
}
inline Actuator_Context_operation_0_ping_param_range_check(Actuator_Context_operation_0_ping_param_vc)
{
    assert(((Actuator_Context_operation_0_ping_param_vc >= 0) && (Actuator_Context_operation_0_ping_param_vc <= 10000)));
}
inline Actuator_Context_operation_0_pong_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_operation_0_pong_param_range_check(dst);
}
inline Actuator_Context_operation_0_pong_param_range_check(Actuator_Context_operation_0_pong_param_vc)
{
    assert(((Actuator_Context_operation_0_pong_param_vc >= 0) && (Actuator_Context_operation_0_pong_param_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context_operation_0_ping_param_assign_value(dst.operation_0_ping_param, src.operation_0_ping_param);
    Actuator_Context_operation_0_pong_param_assign_value(dst.operation_0_pong_param, src.operation_0_pong_param);
}
