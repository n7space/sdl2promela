...
#define Controller_Context__coeff int
...
typedef Controller_Context {
    ...
    Controller_Context__coeff coeff;
}
...
inline Controller_Context__coeff_assign_value(dst, src)
{
    dst = src;
    Controller_Context__coeff_range_check(dst);
}
inline Controller_Context__coeff_range_check(Controller_Context__coeff_vc)
{
    assert(((Controller_Context__coeff_vc >= 0) && (Controller_Context__coeff_vc <= 10000)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__coeff_assign_value(dst.coeff, src.coeff);
}
