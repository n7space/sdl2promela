...
{
    flag ret = TRUE;
    ret = ((((((((*(pVal)) == MyStatus_transition_top)) || (((*(pVal)) == MyStatus_enter_nested)))) || (((*(pVal)) == MyStatus_transition_nested)))) || (((*(pVal)) == MyStatus_leave_nested)));
	    ...
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	                ...
	                break;
	            case 1:
	                (*(pVal)) = MyStatus_enter_nested;
	                break;
	            case 2:
	                (*(pVal)) = MyStatus_transition_nested;
	                break;
	            case 3:
	                (*(pVal)) = MyStatus_leave_nested;
	                break;
	            default:                        /*COVERAGE_IGNORE*/
