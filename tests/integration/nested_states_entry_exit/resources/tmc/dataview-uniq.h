...
typedef enum {
    ...
    MyStatus_enter_nested = 1,
    MyStatus_transition_nested = 2,
    MyStatus_leave_nested = 3
} asn1SccMyStatus;

// please use the following macros to avoid breaking code.
#define asn1SccMyStatus_transition_top MyStatus_transition_top
#define asn1SccMyStatus_enter_nested MyStatus_enter_nested
#define asn1SccMyStatus_transition_nested MyStatus_transition_nested
#define asn1SccMyStatus_leave_nested MyStatus_leave_nested

#define ERR_MYSTATUS		6  /*transition-top | enter-nested | transition-nested | leave-nested*/
...
#define asn1SccMyStatus_REQUIRED_BITS_FOR_ENCODING        2
