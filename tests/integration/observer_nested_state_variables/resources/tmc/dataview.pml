...
#define Actuator_Context_wait_0_ping_param int
#define Actuator_Context_wait_0_pong_param int
...
#define Actuator_States_wait_0_one 0
#define Actuator_States_wait_0_two 1
#define Actuator_Context_state_wait_0_one 0
#define Actuator_Context_state_wait_0_two 1
...
typedef Actuator_Context {
    ...
    Actuator_Context_wait_0_ping_param wait_0_ping_param;
    Actuator_Context_wait_0_pong_param wait_0_pong_param;
}
...
{
    assert((((Observer_Context_state_vc == Observer_Context_state_error) || (Observer_Context_state_vc == Observer_Context_state_reached)) || (Observer_Context_state_vc == Observer_Context_state_idle)));
}
...
{
    assert(((Actuator_States_vc == Actuator_States_wait_0_one) || (Actuator_States_vc == Actuator_States_wait_0_two)));
}
...
{
    assert(((Actuator_Context_state_vc == Actuator_Context_state_wait_0_one) || (Actuator_Context_state_vc == Actuator_Context_state_wait_0_two)));
}
...
inline Actuator_Context_wait_0_ping_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_wait_0_ping_param_range_check(dst);
}
inline Actuator_Context_wait_0_ping_param_range_check(Actuator_Context_wait_0_ping_param_vc)
{
    assert(((Actuator_Context_wait_0_ping_param_vc >= 0) && (Actuator_Context_wait_0_ping_param_vc <= 10000)));
}
inline Actuator_Context_wait_0_pong_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_wait_0_pong_param_range_check(dst);
}
inline Actuator_Context_wait_0_pong_param_range_check(Actuator_Context_wait_0_pong_param_vc)
{
    assert(((Actuator_Context_wait_0_pong_param_vc >= 0) && (Actuator_Context_wait_0_pong_param_vc <= 10000)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context_wait_0_ping_param_assign_value(dst.wait_0_ping_param, src.wait_0_ping_param);
    Actuator_Context_wait_0_pong_param_assign_value(dst.wait_0_pong_param, src.wait_0_pong_param);
}
