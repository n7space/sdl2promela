...
#define Observer_States_found 1
#define Observer_Context__state_wait 0
#define Observer_Context__state_found 1
...
{
    assert(((Observer_States_vc == Observer_States_wait) || (Observer_States_vc == Observer_States_found)));
}
...
{
    assert(((Observer_Context__state_vc == Observer_Context__state_wait) || (Observer_Context__state_vc == Observer_Context__state_found)));
}
