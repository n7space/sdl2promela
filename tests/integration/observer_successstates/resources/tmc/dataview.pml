...
#define Observer_States_found 0
#define Observer_States_wait 1
#define Observer_Context__state_found 0
...
{
    assert(((Observer_States_vc == Observer_States_found) || (Observer_States_vc == Observer_States_wait)));
}
...
{
    assert(((Observer_Context__state_vc == Observer_Context__state_found) || (Observer_Context__state_vc == Observer_Context__state_wait)));
}
