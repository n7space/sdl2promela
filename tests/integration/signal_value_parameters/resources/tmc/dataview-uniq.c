...
{
    flag ret = TRUE;
    ret = ((((*(pVal)) == MyParam_on)) || (((*(pVal)) == MyParam_off)));
    *pErrCode = ret ? 0 :  ERR_MYPARAM;
...
flag asn1SccMyParam_Encode(const asn1SccMyParam* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints)
{
	...
	*pErrCode = 0;
	ret = bCheckConstraints ? asn1SccMyParam_IsConstraintValid(pVal, pErrCode) : TRUE ;
	if (ret && *pErrCode == 0) {
	    switch((*(pVal)))
	    {
	        case MyParam_on:
	        ...
	        default:                    /*COVERAGE_IGNORE*/
	    	    *pErrCode = ERR_UPER_ENCODE_MYPARAM; /*COVERAGE_IGNORE*/
...
flag asn1SccMyParam_Decode(asn1SccMyParam* pVal, BitStream* pBitStrm, int* pErrCode)
{
	...
	*pErrCode = 0;
...

	{
	    ...
	    *pErrCode = ret ? 0 : ERR_UPER_DECODE_MYPARAM;
	    if (ret) {
	        switch(enumIndex)
	        {
	            case 0:
	            ...
	            case 1:
	                ...
	                break;
	            default:                        /*COVERAGE_IGNORE*/
		            *pErrCode = ERR_UPER_DECODE_MYPARAM;     /*COVERAGE_IGNORE*/
		            ret = FALSE;                /*COVERAGE_IGNORE*/
	        }
	    } else {
	        (*(pVal)) = MyParam_on;             /*COVERAGE_IGNORE*/
	    }
	}

	return ret  && asn1SccMyParam_IsConstraintValid(pVal, pErrCode);
}
