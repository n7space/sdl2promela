...
{
    Controller_pong_enum_channel!actuator_pong_enum_Actuator_pong_enum_p1;
}
...
{
    Actuator_ping_enum_channel!controller_ping_enum_Controller_ping_enum_p1;
}
...
Actuator_ping_enum_loop:
        if
        ::  nempty(Actuator_ping_enum_channel);
            Actuator_ping_enum_channel?Actuator_ping_enum_signal_parameter;
...
Controller_pong_enum_loop:
        if
        ::  nempty(Controller_pong_enum_channel);
            Controller_pong_enum_channel?Controller_pong_enum_signal_parameter;
