...
typedef MyParamMessage {
#if asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING == 0
    byte data[1];
#else
    byte data[asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING];
#endif
}
...
chan Actuator_ping_enum_channel = [1] of {MyParamMessage};
MyParam Actuator_ping_enum_signal_parameter;
MyParamMessage Actuator_ping_enum_signal_parameter_message;
bool Actuator_ping_enum_channel_used = 0;
MyIntegerMessage actuator_pong_Actuator_pong_p1_message;
MyInteger actuator_pong_Actuator_pong_p1_var;
MyParamMessage actuator_pong_enum_Actuator_pong_enum_p1_message;
MyParam actuator_pong_enum_Actuator_pong_enum_p1_var;
...
chan Controller_pong_enum_channel = [1] of {MyParamMessage};
MyParam Controller_pong_enum_signal_parameter;
MyParamMessage Controller_pong_enum_signal_parameter_message;
...
MyParamMessage controller_ping_enum_Controller_ping_enum_p1_message;
MyParam controller_ping_enum_Controller_ping_enum_p1_var;
...
inline Actuator_0_RI_0_pong_enum(actuator_pong_enum_Actuator_pong_enum_p1)
{
    MyParam_assign_value(actuator_pong_enum_Actuator_pong_enum_p1_var, actuator_pong_enum_Actuator_pong_enum_p1);
    c_code {
        {
        asn1SccMyParam actuator_pong_enum_Actuator_pong_enum_p1_c_var;
        BitStream actuator_pong_enum_Actuator_pong_enum_p1_stream;
        int actuator_pong_enum_Actuator_pong_enum_p1_rc;
        
        actuator_pong_enum_Actuator_pong_enum_p1_c_var = now.actuator_pong_enum_Actuator_pong_enum_p1_var;
        
        BitStream_Init(&actuator_pong_enum_Actuator_pong_enum_p1_stream,
            now.actuator_pong_enum_Actuator_pong_enum_p1_message.data,
            asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccMyParam_Encode(&actuator_pong_enum_Actuator_pong_enum_p1_c_var,
            &actuator_pong_enum_Actuator_pong_enum_p1_stream,
            &actuator_pong_enum_Actuator_pong_enum_p1_rc,
            0);
        }
    }
    Controller_pong_enum_channel!actuator_pong_enum_Actuator_pong_enum_p1_message;
    printf("channel_send Controller_pong_enum_channel: %d\n", actuator_pong_enum_Actuator_pong_enum_p1_var);
}
...
inline Controller_0_RI_0_ping_enum(controller_ping_enum_Controller_ping_enum_p1)
{
    MyParam_assign_value(controller_ping_enum_Controller_ping_enum_p1_var, controller_ping_enum_Controller_ping_enum_p1);
    c_code {
        {
        asn1SccMyParam controller_ping_enum_Controller_ping_enum_p1_c_var;
        BitStream controller_ping_enum_Controller_ping_enum_p1_stream;
        int controller_ping_enum_Controller_ping_enum_p1_rc;
        
        controller_ping_enum_Controller_ping_enum_p1_c_var = now.controller_ping_enum_Controller_ping_enum_p1_var;
        
        BitStream_Init(&controller_ping_enum_Controller_ping_enum_p1_stream,
            now.controller_ping_enum_Controller_ping_enum_p1_message.data,
            asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING);
        asn1SccMyParam_Encode(&controller_ping_enum_Controller_ping_enum_p1_c_var,
            &controller_ping_enum_Controller_ping_enum_p1_stream,
            &controller_ping_enum_Controller_ping_enum_p1_rc,
            0);
        }
    }
    Actuator_ping_enum_channel!controller_ping_enum_Controller_ping_enum_p1_message;
    printf("channel_send Actuator_ping_enum_channel: %d\n", controller_ping_enum_Controller_ping_enum_p1_var);
}
...
active proctype Actuator_ping_enum() priority 1
{
    ...
    do
    ::  atomic {
        nempty(Actuator_ping_enum_channel);
        Actuator_lock?_;
Actuator_ping_enum_loop:
        if
        ::  nempty(Actuator_ping_enum_channel);
            Actuator_ping_enum_channel?Actuator_ping_enum_signal_parameter_message;
            c_code {
                {
                asn1SccMyParam Actuator_ping_enum_signal_parameter_c_var;
                BitStream Actuator_ping_enum_signal_parameter_stream;
                int Actuator_ping_enum_signal_parameter_rc;BitStream_AttachBuffer(&Actuator_ping_enum_signal_parameter_stream,
                    now.Actuator_ping_enum_signal_parameter_message.data,
                    asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccMyParam_Decode(&Actuator_ping_enum_signal_parameter_c_var,
                    &Actuator_ping_enum_signal_parameter_stream,
                    &Actuator_ping_enum_signal_parameter_rc);
                now.Actuator_ping_enum_signal_parameter = Actuator_ping_enum_signal_parameter_c_var;
                }
            }
            printf("channel_recv Actuator_ping_enum_channel: %d\n", Actuator_ping_enum_signal_parameter);
            Actuator_ping_enum_channel_used = 1;
            Actuator_0_PI_0_ping_enum(Actuator_ping_enum_signal_parameter);
            goto Actuator_ping_enum_loop;
        ::  empty(Actuator_ping_enum_channel);
            skip;
        fi;
        Actuator_lock!1;
    }
...
active proctype Controller_pong_enum() priority 1
{
    ...
    do
    ::  atomic {
        nempty(Controller_pong_enum_channel);
        Controller_lock?_;
Controller_pong_enum_loop:
        if
        ::  nempty(Controller_pong_enum_channel);
            Controller_pong_enum_channel?Controller_pong_enum_signal_parameter_message;
            c_code {
                {
                asn1SccMyParam Controller_pong_enum_signal_parameter_c_var;
                BitStream Controller_pong_enum_signal_parameter_stream;
                int Controller_pong_enum_signal_parameter_rc;BitStream_AttachBuffer(&Controller_pong_enum_signal_parameter_stream,
                    now.Controller_pong_enum_signal_parameter_message.data,
                    asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING);
                asn1SccMyParam_Decode(&Controller_pong_enum_signal_parameter_c_var,
                    &Controller_pong_enum_signal_parameter_stream,
                    &Controller_pong_enum_signal_parameter_rc);
                now.Controller_pong_enum_signal_parameter = Controller_pong_enum_signal_parameter_c_var;
                }
            }
            printf("channel_recv Controller_pong_enum_channel: %d\n", Controller_pong_enum_signal_parameter);
            Controller_pong_enum_channel_used = 1;
            Controller_0_PI_0_pong_enum(Controller_pong_enum_signal_parameter);
            goto Controller_pong_enum_loop;
        ::  empty(Controller_pong_enum_channel);
            skip;
        fi;
        Controller_lock!1;
    }
