...
#define Actuator_Context__enum_param int
...
#define Controller_Context__pong_enum_param int
...
#define Actuator_Context__enum_param_on 0
#define Actuator_Context__enum_param_off 1
...
#define Controller_Context__state_waitenum 1
...
#define Controller_Context__pong_enum_param_on 0
#define Controller_Context__pong_enum_param_off 1
...
typedef Actuator_Context {
    ...
    Actuator_Context__enum_param enum_param;
}
...
typedef Controller_Context {
    ...
    Controller_Context__pong_enum_param pong_enum_param;
}
...
inline Actuator_Context__enum_param_assign_value(dst, src)
{
    dst = src;
    Actuator_Context__enum_param_range_check(dst);
}
inline Actuator_Context__enum_param_range_check(Actuator_Context__enum_param_vc)
{
    assert(((Actuator_Context__enum_param_vc == Actuator_Context__enum_param_on) || (Actuator_Context__enum_param_vc == Actuator_Context__enum_param_off)));
}
inline Actuator_Context_assign_value(dst, src)
{
    ...
    Actuator_Context__enum_param_assign_value(dst.enum_param, src.enum_param);
}
...
{
    assert(((Controller_Context__state_vc == Controller_Context__state_wait) || (Controller_Context__state_vc == Controller_Context__state_waitenum)));
}
...
inline Controller_Context__pong_enum_param_assign_value(dst, src)
{
    dst = src;
    Controller_Context__pong_enum_param_range_check(dst);
}
inline Controller_Context__pong_enum_param_range_check(Controller_Context__pong_enum_param_vc)
{
    assert(((Controller_Context__pong_enum_param_vc == Controller_Context__pong_enum_param_on) || (Controller_Context__pong_enum_param_vc == Controller_Context__pong_enum_param_off)));
}
inline Controller_Context_assign_value(dst, src)
{
    ...
    Controller_Context__pong_enum_param_assign_value(dst.pong_enum_param, src.pong_enum_param);
}
