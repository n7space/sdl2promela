...
#define asn1SccMyParam_on MyParam_on
#define asn1SccMyParam_off MyParam_off

#define ERR_MYPARAM		6  /*on | off*/
flag asn1SccMyParam_IsConstraintValid(const asn1SccMyParam* pVal, int* pErrCode);

void asn1SccMyParam_Initialize(asn1SccMyParam* pVal);

#define ERR_UPER_ENCODE_MYPARAM		7  /**/
#define asn1SccMyParam_REQUIRED_BYTES_FOR_ENCODING       1
#define asn1SccMyParam_REQUIRED_BITS_FOR_ENCODING        1

flag asn1SccMyParam_Encode(const asn1SccMyParam* pVal, BitStream* pBitStrm, int* pErrCode, flag bCheckConstraints);

#define ERR_UPER_DECODE_MYPARAM		8  /**/
flag asn1SccMyParam_Decode(asn1SccMyParam* pVal, BitStream* pBitStrm, int* pErrCode);
