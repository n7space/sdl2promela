...
typedef enum {
    MyChoice_NONE,
    MyChoice_first_PRESENT,
    MyChoice_secONd_PRESENT
...
#define ERR_MYCHOICE		31  /**/
#define ERR_MYCHOICE_FIRST_2		16  /**/
#define ERR_MYCHOICE_SECOND_2		26  /**/
...
#define ERR_UPER_ENCODE_MYCHOICE		32  /**/
#define ERR_UPER_ENCODE_MYCHOICE_FIRST_2		17  /**/
#define ERR_UPER_ENCODE_MYCHOICE_SECOND_2		27  /**/
...
#define ERR_UPER_DECODE_MYCHOICE		33  /**/
#define ERR_UPER_DECODE_MYCHOICE_FIRST_2		18  /**/
#define ERR_UPER_DECODE_MYCHOICE_SECOND_2		28  /**/
flag asn1SccMyChoice_Decode(asn1SccMyChoice* pVal, BitStream* pBitStrm, int* pErrCode);
typedef asn1SccUint asn1SccMyTestInteger;


#define ERR_MYTESTINTEGER		6  /*(1 .. 8)*/
...
#define ERR_ENVIRON_TEST_P1_2		116  /**/
...
#define ERR_UPER_ENCODE_ENVIRON_TEST_P1_2		117  /**/
...
#define ERR_T_UINT32		41  /*(0 .. 4294967295)*/
...
#define ERR_T_RUNTIME_ERROR		96  /**/
#define ERR_T_RUNTIME_ERROR_NOERROR_2		71  /**/
#define ERR_T_RUNTIME_ERROR_ENCODEERROR_2		81  /**/
#define ERR_T_RUNTIME_ERROR_DECODEERROR_2		91  /**/
...
#define ERR_UPER_ENCODE_T_RUNTIME_ERROR		97  /**/
#define ERR_UPER_ENCODE_T_RUNTIME_ERROR_NOERROR_2		72  /**/
#define ERR_UPER_ENCODE_T_RUNTIME_ERROR_ENCODEERROR_2		82  /**/
#define ERR_UPER_ENCODE_T_RUNTIME_ERROR_DECODEERROR_2		92  /**/
...
#define ERR_UPER_DECODE_T_RUNTIME_ERROR		98  /**/
#define ERR_UPER_DECODE_T_RUNTIME_ERROR_NOERROR_2		73  /**/
#define ERR_UPER_DECODE_T_RUNTIME_ERROR_ENCODEERROR_2		83  /**/
#define ERR_UPER_DECODE_T_RUNTIME_ERROR_DECODEERROR_2		93  /**/
...
#define ERR_UPER_ENCODE_PID_RANGE		102  /**/
...
#define ERR_UPER_DECODE_PID_RANGE		103  /**/
...
#define ERR_UPER_DECODE_PID		108  /**/
