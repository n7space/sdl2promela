...
#define Actuator_Context_nested_0_param int
#define Actuator_Context_nested_0_data_first int
#define Actuator_Context_nested_0_data_secONd int
...
#define Controller_Context_ticks int
...
#define Actuator_Context_nested_0_data_NONE 0
#define Actuator_Context_nested_0_data_first_PRESENT 1
#define Actuator_context_nested_0_data_selection_first_PRESENT 1
#define Actuator_Context_nested_0_data_secONd_PRESENT 2
#define Actuator_context_nested_0_data_selection_secONd_PRESENT 2
...
#define PID_env 3
typedef Actuator_Context_nested_0_data_data {
    Actuator_Context_nested_0_data_first first;
    Actuator_Context_nested_0_data_secONd secONd;
}
...
typedef Actuator_Context_nested_0_data {
    Actuator_Context_nested_0_data_data data;
    int selection;
}
...
{
    dst = src;
    Actuator_Context_nested_0_param_range_check(dst);
}
inline Actuator_Context_nested_0_param_range_check(Actuator_Context_nested_0_param_vc)
{
    assert(((Actuator_Context_nested_0_param_vc >= 0) && (Actuator_Context_nested_0_param_vc <= 10000)));
}
inline Actuator_Context_nested_0_data_first_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_nested_0_data_first_range_check(dst);
}
inline Actuator_Context_nested_0_data_first_range_check(Actuator_Context_nested_0_data_first_vc)
{
    assert(((Actuator_Context_nested_0_data_first_vc >= 0) && (Actuator_Context_nested_0_data_first_vc <= 10000)));
}
inline Actuator_Context_nested_0_data_secONd_assign_value(dst, src)
{
    dst = src;
    Actuator_Context_nested_0_data_secONd_range_check(dst);
}
inline Actuator_Context_nested_0_data_secONd_range_check(Actuator_Context_nested_0_data_secONd_vc)
{
    assert(((Actuator_Context_nested_0_data_secONd_vc >= 0) && (Actuator_Context_nested_0_data_secONd_vc <= 10000)));
}
inline Actuator_Context_nested_0_data_assign_value(dst, src)
{
    dst.selection = src.selection;
    if
    ::  (dst.selection == Actuator_Context_nested_0_data_first_PRESENT);
        Actuator_Context_nested_0_data_first_assign_value(dst.data.first, src.data.first);
    ::  (dst.selection == Actuator_Context_nested_0_data_secONd_PRESENT);
        Actuator_Context_nested_0_data_secONd_assign_value(dst.data.secONd, src.data.secONd);
    ::  else;
        skip;
    fi;
}
inline Actuator_context_nested_0_data_selection_assign_value(dst, src)
{
    dst = src;
}
...
{
    assert(((Controller_Context_test_param_vc >= 1) && (Controller_Context_test_param_vc <= 8)));
}
inline Controller_Context_ticks_assign_value(dst, src)
{
    dst = src;
    Controller_Context_ticks_range_check(dst);
}
inline Controller_Context_ticks_range_check(Controller_Context_ticks_vc)
{
    assert(((Controller_Context_ticks_vc >= 1) && (Controller_Context_ticks_vc <= 8)));
}
