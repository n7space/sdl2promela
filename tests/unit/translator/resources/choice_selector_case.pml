inline Complexsdl_0_transition(id)
{
  ...
  ::if
    ...
    ::(complexsdl_transition_id == 1)->
      if
      ::(global_state.complexsdl.tmp.selection == Complexsdl_Testchoice_Selection_secondName_present)->
        MyInteger_assign_value(global_state.complexsdl.param, 0);
      ::(global_state.complexsdl.tmp.selection == Complexsdl_Testchoice_Selection_problematicName_present)->
        MyInteger_assign_value(global_state.complexsdl.param, global_state.complexsdl.tmp.data.problematicName);
      fi;
