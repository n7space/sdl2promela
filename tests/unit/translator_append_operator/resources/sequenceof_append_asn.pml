inline Complexsdl_0_transition(id)
{
  ...
  ::if
    ...
    ::(complexsdl_transition_id == 1)->
      {
        global_state.complexsdl.data.length = 3;
        MyInteger_assign_value(global_state.complexsdl.data.data[0], 1);
        MyInteger_assign_value(global_state.complexsdl.data.data[1], 2);
        MyInteger_assign_value(global_state.complexsdl.data.data[2], 3);
      }
      {
        int i0;
